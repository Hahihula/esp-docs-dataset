**Chapter Title:**
Chapter 1 Processor Instruction Extensions (EE)

**Section Header:**
1.8.150 EE.VMULAS.S8.ACCX.LD.XP.QUP

**Subsection - Instruction Word Table:**
- qu[2:1] | qy[0] | qs0[2:0] | qu[0] | qs1[2:0] | qx[1:0] | qs1[2:0] | ad[3:0] | as[3:0] | 111 | qx[2]

**Subsection - Assembler Syntax:**
EE.VMULAS.S8.ACCX.LD.XP.QUP qu, as, ad, qx, qy, qs0, qs1

**Subsection - Description:**
This instruction divides registers qx and qy into 16 data segments by 8 bits. Then it performs a signed multiply-accumulate operation on the sets of segments respectively. The accumulated result is added to the value in special register ACCX. Then, the sum obtained is saturated and then stored in ACCX.
