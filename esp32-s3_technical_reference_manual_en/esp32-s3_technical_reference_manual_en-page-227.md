...
**Section Header:**
1.8.151 EE.VMULAS.SB.QACC

**Instruction Word:**
000110100 | qy[2] | 1 | qx[2:0] | 11000100
...
**Operation:**
```
QACC_L[19:0] = min(max(QACC_L[19:0] | 0), qy[7:0]) * qx[7:0], -2^{19})],
           ^{19}-1)
...
QACC_H[19:0] = min(max(QACC_H[19:0] | 0), qx[71:64], qy[71:64], -2^{19}), 2^{19}-1)
...
**Document Title and Version Note:**
