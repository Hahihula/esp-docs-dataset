...
| EFUSE_RD_KEY5_DATAO_REG | Register 0 of BLOCK9 (KEY5) | 0x013C | RO |
...
| EFUSE_RD_SYS_PART2_DATAO_REG | Register 0 of BLOCK10 (system) | 0x015C | RO |
...
| EFUSE_RDRepeat_ERR4_REG | Programming error record register 4 of BLOCK0 | 0x0190 | RO |
| EFUSE_RD_RS_ERRO_REG | Programming error record register 0 of BLOCK1 ~ 10 | 0x01C0 | RO |
