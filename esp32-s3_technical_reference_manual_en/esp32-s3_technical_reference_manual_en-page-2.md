...
- Release Status at a Glance
  - On the very next page is a minimal list of all chapters from where you can directly jump to a specific chapter.
...
- Use the native Navigation function of your PDF viewer to navigate through the documents. Most PDF viewers support to go Up. Down, Previous, Next, Back, Forward and Page 
  with buttons, menu, or hot keys.
