...
**Subtitle:**
38.3.3 Channel O and Channel 1 Incrementing Together
...
Figure 38.3-3 illustrates how channel 0 and channel 1 are configured to increment on the positive edge of sig_ch0_un and sig_ch1_un respectively at the same time. It can be seen in Figure 38.3-3 that control signal ctrl_ch0_un and ctrl_ch1_un have the same waveform, as input pulse signals sig_ch0_un and sig_ch1_un.
