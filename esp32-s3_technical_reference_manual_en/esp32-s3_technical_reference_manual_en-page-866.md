...
| `0x029D` | `0x1D` | `0x029E` | `0x1F` | `0x029F` | `0x20` |
...
AES accelerator provides two Standard Incrementing Functions for the CTR block operation, which are INC_32 and INC_128 Standard Incrementing Functions. By setting the AES_INC_SEL_REG register to 0 or 1, users can choose the INC_32 or INC_128 functions respectively. For details on the Standard Unincrementing Function, please see Chapter B.1 The Standard Incrementing Function in NIST SP 800-38A.
...
**Footer:**
Espressif Systems
Page number 866 ESP32-S3 TRM (Version 1.7)
