...
- Use the native Navigation function of your PDF viewer to navigate through the documents. Most PDF viewers support go Up, Down, Previous, Next, Back, Forward and Page buttons, menu or hotkeys.
  
- You can also use the built-in GoBack button on the upper right corner on each page back to previous place before you click a link within document. Note this feature may only work with some Acrobat-specific PDF viewers (for example, Acrobat Reader and Adobe DC) browsers with built-in Acrobat-specific PDF viewers or extensions (for example, Firefox).