...
### 34.2.2.1 Data Frames and Remote Frames
...
they do not contain any data bytes. However, data frames and remote frames share many fields. Figure 34.2-1
illustrates the fields and sub-fields of different frames and formats.

#### Arbitration Field

When two or more nodes transmit data or remote frames simultaneously, the arbitration field is used to
