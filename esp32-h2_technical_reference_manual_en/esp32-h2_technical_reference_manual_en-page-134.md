...
```markdown
Register 3.23. GDMA_IN_ERR_EOF_DES_ADDR_CHn_REG (n: 0-2) (0x008C+0xC0*n)
...
Register 3.24. GDMA_IN_DSCR_CHn_REG (n: 0-2) (0x0090+0xC0*n)
...
Register 3.25. GDMA_IN_DSCR_BFO_CHn_REG (n: 0-2) (0x0094+0xC0*n)
