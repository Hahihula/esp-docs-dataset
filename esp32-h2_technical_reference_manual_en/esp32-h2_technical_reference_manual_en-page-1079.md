...
PWMA/B [with T symbols]

Figure 36.3-20. Count-Up-Down, Fault or Synchronization Events, with Same Modulation on PWMxA and PWMxB
```

FAULT0 and T1 selects FAULT1. The events selected by T0 and T1 can be configured independently, and these events can be FAULT0, FAULT1, FAULT2 or synchronous events. For detailed configuration, see section 36.3.3.1.
