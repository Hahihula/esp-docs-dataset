...
Figure 35.3-4 illustrates how Hpointn and Lpointn are used to generate the PWM output signal with a fixed duty cycle.

![Figure 35.3-4. LED PWM Output Signal Diagram](image)
