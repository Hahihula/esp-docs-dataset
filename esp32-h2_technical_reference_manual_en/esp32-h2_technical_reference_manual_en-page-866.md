...
Figure 30.5-8. I2Cmaster Reading I2Cslave with a 7-bit Address in Segments
...
SCL and SDA lines connect Master to Slave.
...
Figure 30.5-8 shows how I2Cmaster reads (N+M) bytes of data from an I2C slave in two/three segments separated by END commands. Configuration procedures are described as follows:

1. The procedures for Segment0 is similar to 30.5-5, except that the last command is an END.
