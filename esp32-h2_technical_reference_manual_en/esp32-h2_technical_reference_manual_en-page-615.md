...
21.2.3 Downstream Digital Signature Algorithm Mode
...
Before starting the DSA module, users need to obtain the parameter decryption key for the DSA module through HMAC calculation. For more information, please see Chapter 24 Digital Signature Algorithm (DSA).
```