...
MCPWM_TASK_TIMERO_SYNC_EN Configures whether or not to receive timer0 sync task.
    0: No effect
    1: Receive
        (R/W)
...
MCPWM_TASK_TIMERO_PERIOD_UP_EN Configures whether or not to receive timer0 period update task.
    0: No effect
    1: Receive
        (R/W)
