...
```markdown
2. TCK is clocked another (0 × 2 + 1) × (4⁰) = 1 time with the same settings as step 1.
...
## 33.3.5 USB-to-JTAG Interface: Response Capture Unit
...
## 33.3.6 USB-to-JTAG Interface: Control Transfer Requests
