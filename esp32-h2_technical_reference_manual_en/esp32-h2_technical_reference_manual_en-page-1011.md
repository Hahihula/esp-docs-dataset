...
34.4.9 Arbitration Lost Capture
...
Table 34.4-13 illustrates bits and fields of `TWAI_ERR_CODE_CAP_REG` whilst Figure 34.4-5 illustrates the bit positions of a TWAI message.

Figure 34.4-5. Positions of Arbitration Lost Bits

Table 34.4-13. Bit Information of `TWAI_ARB_LOST_CAP_REG (0x2c)`
```