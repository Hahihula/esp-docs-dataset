...
*   Configure GP-SPI2 registers listed in Table 29.5-7.
*   Configure SPI CS setup time and hold time according to Section 29.6.
*   Set the property of FSPICLK according to Section 29.7.
...
### 29.5.9.4 Half-Duplex Communication (1/2/4-bit Mode)
...
As described in Section 29.5.9.2, the properties of GP-SPI2 states: CMD, ADDR, DUMMY, DOUT and DIN, such as cycle length, value, and parallel bus bit mode, can be set independently. For the register configuration, see Table 29.5-7.
