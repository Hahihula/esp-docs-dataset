...
| 13  | IO_MUX_GPIOn_FUNC_IE                                                      |
| 12  | IO_MUX_GPIOn_WPU                                                           |
| 11  | IO_MUX_GPIOn_SLP_SEL                                                      |
| 10  | IO_MUX_GPIOn_MCU_WPDU                                                     |
| 9   | IO_MUX_GPIOn_MCU_DRV                                                       |
| 8   | Reset                                                                      |
...
IO_MUX_GPIOn_FUNC_WPD Configures whether or not to enable pull-down resistor of GPIO.
O: Disable
1: Enable
(R/W)
```