...
For example, when the size is 64, all registers in the register block will be used. The mapping between offset and registers now is shown in Table 26.4-2.

**Table 26.4-2. Mapping Between Offsets and Registers**
...
## 26.4.5 Manual Encryption Block
