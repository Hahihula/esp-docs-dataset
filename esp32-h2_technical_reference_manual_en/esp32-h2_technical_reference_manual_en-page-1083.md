...
All switch combinations are supported, but not all of them represent the typical modes of use. Table 36.3-6 documents some typical dead time configurations. In these configurations, the position of S4 and S5 sets PWMxA as the common source of both falling edge delays (FED) and rising edge delays (RED). The modes presented in table 36.3-6 may be categorized as follows:
