...
Figure 31.6-1. I2S Clock Generator

The following formula shows the relation between I2S_TX/RX_CLK frequency fI2S_TX/RX_CLK and the divider clock source frequency fI2S_CLK_S:

fI2S_TX/RX_CLK = (fI2S_CLK_S) / (N + a/b)
