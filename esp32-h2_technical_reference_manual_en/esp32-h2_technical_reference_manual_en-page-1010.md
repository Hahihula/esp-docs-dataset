...
The following Table 34.4-11 shows the fields of the `TWAI_ERR_CODE_CAP_REG`:

Table 34.4-11. Bit Information of `TWAI_ERR_CODE_CAP_REG` (0x30)
...
The following Table 34.4-12 shows how to interpret the SEG.0 to SEG.4 bits.

Table 34.4-12. Bit Information of Bits SEG.4 - SEG.0
