...
SOC_ETM_Chn_EVT_ID (n: 0-49) Configures the event ID of channeln. See Table 10.3-1. (R/W)

Register 10.8. SOC_ETM_CHn_TASK_ID_REG (n: 0-49) (0x001C+0x8*n)

SOC_ETM_Chn_TASK_ID (n: 0-49) Configures the task ID of channeln. See Table 10.3-2. (R/W)
```