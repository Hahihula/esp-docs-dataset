...
```markdown
Register 3.30. GDMA_OUT_EOF_BFR_DES_ADDR_CHn_REG (n: 0-2) (0x00EC+0xC0*n)

GDMA_OUT_EOF_BFR_DES_ADDR_CHn Represents the address of the transmit descriptor before the last transmit descriptor. (RO)

Register 3.31. GDMA_OUT_DSCR_CHn_REG (n: 0-2) (0x00F0+0xC0*n)
...
Register 3.32. GDMA_OUT_DSCR_BFO_CHn_REG (n: 0-2) (0x00F4+0xC0*n)
