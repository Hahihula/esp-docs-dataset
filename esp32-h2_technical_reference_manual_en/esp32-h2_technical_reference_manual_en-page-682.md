...
# Chapter 26 ## External Memory Encryption and Decryption (XTS_AES)
...
### 26.3 Module Structure

The External Memory Encryption and Decryption module consists of two blocks, namely the Manual Encryption block and Auto Decryption block. The module architecture is shown in Figure 26.3-1.