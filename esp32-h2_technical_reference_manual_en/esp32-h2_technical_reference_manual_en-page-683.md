...
Figure 26.3-1. Architecture of the External Memory Encryption and Decryption
...
In the System Registers peripheral (see 16 System Registers), the following three bits in register HP_SYSTEM_EXTERNAL_DEVICE_ENCRYPT_DECRYPT_CONTROL_REG are relevant to the external memory encryption and decryption:
...
`EFUSE_DIS_DOWNLOAD_MANUAL_ENCRYPT` and `EFUSE_SPI_BOOT_CRYPT_CNT`. For detailed information, please see Chapter 5 eFuse Controller (EFUSE).



26.4 Functional Description

26.4.1 XTS Algorithm
