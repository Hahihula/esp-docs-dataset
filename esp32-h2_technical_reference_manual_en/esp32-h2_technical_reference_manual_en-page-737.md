...
```markdown
Register 28.20. UART_CLK_CONF_REG (0x0088)

| Bit | 31 | 30 | 29 | 28 | 27 | 26 | 25 | 24 | 23 |
|-----|----|----|----|----|----|----|----|----|----|
|     |    | UART_RX_RST_CORE | UART_TX_RST_CORE | UART_RX_SCLK_EN | UART_TX_SCLK_EN | (reserved) | (reserved) | Reset |
...
```markdown
Register 28.21. UART_STATUS_REG (0x001C)

| Bit | 31 | 30 | 29 | 28 | 27 | 26 | 25 | 24 | 23 |
|-----|----|----|----|----|----|----|----|----|----|
|     | UART_TXD | UART_RTSN | UART_DTRN | (reserved) | UART_RXFIFO_CNT | UART_TXFIFO_CNT | UART_RXD | UART_CTSN | UART_DSRN |
|     |          |           |         |              |               |             |       |        |      |
