...
Figure 35.3-2 illustrates the relation between LEDC_CLKx clock pulses and ref_pulsex clock pulses when LEDC_CLK_DIV is a non-integer.
...
Espressif Systems          1032          ESP32-H2 TRM (Version 1.1)
