...
In Typical AES working mode, when filling keys into `AES_KEY_m_REG` registers, users should follow the key endianness type specified in Table 19.5-3 and Table 19.5-4.

### Table 19.5-3. Key Endianness Type for AES-128 Encryption and Decryption
...
### Table 19.5-4. Key Endianness Type for AES-256 Encryption and Decryption
