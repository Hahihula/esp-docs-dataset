...
| addr | [31] level | [30:16] period | [15] level | [14:0] period |
|-------|------------|----------------|----------|---------------|
|       |            |                |          |               |
| ...   | ...        | ...            | ...      | ...           |
| addr  | [31] level | [30:16]* period| [15] level | [14:0] period |
...
The RAM is divided into four 48 × 32-bit blocks. By default, each channel uses one block (block 0 for channel 0, block 1 for channel 1, and so on).
