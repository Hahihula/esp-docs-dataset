...
```markdown
## 31.9.1.2 Endian Control of Channel Valid Data

When I2S reads data through GDMA, the data endian under various data width is controlled by `I2S_TX_BIG_ENDIAN`. Table 31.9-2 shows how `I2S_TX_BIG_ENDIAN` controls the reading of the data with different valid data widths of the channel.

Table 31.9-2. Endian of Channel Valid Data
...
## 31.9.1.3 A-law/μ-law Compression and Decompression
