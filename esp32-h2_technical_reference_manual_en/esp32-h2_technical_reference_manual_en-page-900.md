...
# 31.5 Supported Audio Standards
...
**Note:**  
`I2S_TX/RX_TDM_EN` and `I2S_TX/RX_PDM_EN` must not be configured to 1 or 0 at the same time, otherwise ESP32-H2 I2S will transmit data incorrectly in a mode that is neither TDM nor PDM.

## 31.5.1 TDM Philips Standard
...
Compared with the basic Philips standard, TDM Philips standard supports multiple channels. See Figure 31.5-1.