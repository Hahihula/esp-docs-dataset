...
ESP32-H2 provides a 52-bit timer, which can be used to generate tick interrupts for the operating system, or be used as a general timer to generate periodic interrupts or one-time interrupts.

The timer consists of two counters: UNIT0 and UNIT1. The count values can be monitored by three comparators COMP0, COMP1, and COMP2. See the timer block diagram on Figure 12.1-1.

![Figure 12.1-1. System Timer Structure](image_path_if_available)
