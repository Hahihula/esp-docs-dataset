...
```markdown
Register 46.11. I2S_TX_CONF1_REG (0x002C)
...
I2S_TX_TDM_WS_WIDTH Configures the width of I2SnO_WS_out (WS default level) at idle level in TDM mode. The width of I2SnO_WS_out at idle level in TDM mode = (I2S_TX_TDM_WS_WIDTH[8:0] +1) x T_BCK. (R/W)
