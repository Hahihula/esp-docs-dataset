...
4. Write the address of `I2C_slave` and data to be sent to TX RAM of `I2C_master` in either FIFO mode or non-FIFO mode according to Section 44.4.10.
5. Write the address of `I2C_slave` to `I2C_SLAVE_ADDR` (slave) in `I2C_SLAVE_ADDR_REG` (slave) register
