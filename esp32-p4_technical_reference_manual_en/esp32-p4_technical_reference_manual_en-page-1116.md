...
The addresses in this section are relative to RTC_WDT base address provided in Table 7.3-2 in Chapter 7 System and Memory.
...
| RTC_WDT_INT_RAW_REG | Configure whether to generate timeout interrupt | 0x0024 | R/WTC/SS |
...
MWDT registers are part of the timer submodule and are described in Section 16.5 Register Summary in Chapter 16 Timer Group (TIMG).

The addresses of RWDT and SWD registers in this section are relative to RTC_WDT base address provided in Table 7.3-2 in Chapter 7 System and Memory.
```