...
An overload frame has the same bit fields as an error frame containing an Active Error Flag. The key difference is in the cases that can trigger the transmission of an overload frame. Figure 53.2-3 below shows the bit fields of an overload frame.

![Figure 53.2-3. Fields of an Overload Frame](image)
