...
[Diagram: Bitfield for register LP_I2C_SCL_HIGH_PERIOD_REG]
| 31 | 16 | 15 | 9 | 8 | 0 |
|----|----|----|---|---|---|
| 0  | 0  | 0  | 0 | 0 | Reset |
...
LP_I2C_SCL_WAIT_HIGH_PERIOD Configures the SCL FSM's waiting period for SCL high level in master mode.
Measurement unit: i2c_sclk
(R/W)

Register 44.40. LP_I2C_SCL_START_HOLD_REG (0x0040)

[Diagram: Bitfield for register LP_I2C_SCL_START_HOLD_REG]
| 31 | 9 | 8 | 0 |
|----|---|---|---|
| 0  | 0 | Reset |
