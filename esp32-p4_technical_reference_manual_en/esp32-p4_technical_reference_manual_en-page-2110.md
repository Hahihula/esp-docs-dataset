...
ESP32-P4 has six UART controllers, including five regular UARTs and one low-power (LP) UART. These UARTs are compatible with various UART devices, and support Infrared Data Association (IrDA) and RS485 communication. In this chapter, the five regular UART controllers are referred to as UARTn, in which n denotes 0, 1, 2, 3, or 4. LP UART is the cut-down version of the regular UART, with a separate group of registers. For differences between UART and LP UART, please refer to Table 42.2-1.

### 42.2 Features

Table 42.2-1 lists the feature comparison between UART and LP UART:

**Table 42.2-1. UART and LP UART Feature Comparison**
