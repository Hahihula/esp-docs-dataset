...
```markdown
## 44.6.4 I2Cmaster Writes to I2Cslave with a 7-bit Address in Multiple Command Sequences

### 44.6.4.1 Introduction

Figure 44.6-4. I2Cmaster Writing to I2Cslave with a 7-bit Address in Multiple Sequences
```
