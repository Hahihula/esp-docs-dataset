...
```markdown
All seven settings of the duty cycle are shown in Figure 56.3-28.

Figure 56.3-28. Possible Duty Cycle Settings for Sustaining Pulses in the PWM Carrier Submodule

56.3.3.4 Fault Detection Module
