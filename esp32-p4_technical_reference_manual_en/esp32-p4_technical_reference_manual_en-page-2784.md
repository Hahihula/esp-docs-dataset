...
iii. Write the linear duty cycle fading configuration to (`LEDC_CHn_MEM` starting address + duty cycle range number * 4), the `LEDC_CHn_MEM` starting address is provided in Table 55.7-1.
...
i. The same as Step 1 in Section 55.4.3.1.
ii. The same as Step 2 in Section 55.4.3.1.
iii. Configure multiple duty cycle ranges with the following steps. Write the gamma curve fading configuration to (`LEDC_CHn_MEM` starting address + duty cycle range number * 4), the `LEDC_CHn_MEM` starting address is provided in Table 55.7-1.
