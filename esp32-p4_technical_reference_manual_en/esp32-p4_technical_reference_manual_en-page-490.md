...
|--------------------------------------------|-----------|------------------------|----------------------------------------------|-----------------------------------------------------------------------------|
| EFUSE_FLASH_PAGE_SIZE                      | 2         | N                      | 18                                            | Represents flash page size.                                                |
| EFUSE_FLASH_ECC_EN                         | 1         | N                      | 18                                            | Represents whether ECC is enabled during flash boot.                       |
| EFUSE_DIS_USB_OTG_DOWNLOAD_MODE            | 1         | N                      | 18                                            | Represents whether download via USB-OTG is disabled.                       |
...
| EFUSE_DCDC_VSET                            | 5         | Y                      | N/A                                          | Represents the default DCDC voltage.                                      |
| EFUSE_OPXA_TIEH_SELO                       | 2         | Y                      | 2                                             | Represents which output source is used for Extern Power (VO1).               |
| EFUSE_OPXA_TIEH_SEL1                       | 2         | Y                      | 2                                             | Represents which output source is used for Extern Power (VO2).               |
```