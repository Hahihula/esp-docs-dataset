...
```markdown
## 50.4.3.1 Host Mode FIFOs and Queues

The following FIFOs are used in Host mode, see Figure 50.4-3:

Figure 50.4-3. Host Mode FIFOs
...
## 50.4.3.2 Device Mode FIFOs

The following FIFOs are used in Device mode, see Figure 50.4-4:
```