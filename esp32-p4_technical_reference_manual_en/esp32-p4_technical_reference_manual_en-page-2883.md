...
```markdown
Register 56.35. MCPWM_TASK_EN_REG (0x0124)
...
MCPWM_TASK_TIMERO_SYNC_EN Configures whether to receive timer0 sync task.
O: No effect
1: Receive
(R/W)
...
MCPWM_TASK_TIMERO_PERIOD_UP_EN Configures whether to receive timer0 period update task.
O: No effect
1: Receive
(R/W)
