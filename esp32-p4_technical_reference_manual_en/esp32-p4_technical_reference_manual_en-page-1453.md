...
26.4.2.5 Point Addition (Point Add)

Point Addition can be represented as:

R = (Rx, Ry) = (Jx, Jy, Jz) = (Px, Py, 1) + (Qx, Qy, Qz)
...
26.4.2.6 Jacobian Point Verification (Jacobian Point Verif)
...
26.4.2.7 Affine Point Verification + Jacobian Point Multiplication (Affine Point Verif + Jacobian Point Multi)
