...
```markdown
Register 43.19. SPI_DMA_INT_RAW_REG (0x003C)
...
| 28  | SPI_MST_TX_AFIFO_ERR_INT_RAW   | The raw interrupt status of SPI_MST_TX_AFIFO_ERR_INT.                      |
| 27  | SPI_MST_RX_AFIFO_ERR_INT_RAW   | The raw interrupt status of SPI_MST_RX_AFIFO_ERR_INT.                      |
| 26  | SPI_SLV_CMD_ERR_INT_RAW       | The raw interrupt status of SPI_SLV_CMD_ERR_INT.                           |
| 25  | SPI_SLR_ADD_ERR_INT_RAW       | The raw interrupt status of SPI_SLR_ADD_ERR_INT.                           |
| 24  | SPI_DMA_SEG_DONE_INT_RAW      | The raw interrupt status of SPI_DMA_SEG_DONE_INT.                          |
...
| 15  | SPI_SLV_CMD7_INT_RAW          | The raw interrupt status of SPI_SLV_CMD7_INT.                              |
| 14  | SPI_SLV_CMD9_INT_RAW          | The raw interrupt status of SPI_SLV_CMD9_INT.                              |
| 13  | SPI_SLV_CMD8_INT_RAW          | The raw interrupt status of SPI_SLV_CMD8_INT.                              |
| 12  | SPI_SLV_EN_QPI_INT_RAW        | The raw interrupt status of SPI_SLV_EN_QPI_INT.                            |
| 11  | SPI_SLV_EX_QPI_INT_RAW        | The raw interrupt status of SPI_SLV_EX_QPI_INT.                            |
| 10  | SPI_DMA_OUTFIFO_EMPTY_ERR_INT_RAW | The raw interrupt status of SPI_DMA_OUTFIFO_EMPTY_ERR_INT.               |
| 9   | SPI_DMA_INFIFO_FULL_ERR_INT_RAW | The raw interrupt status of SPI_DMA_INFIFO_FULL_ERR_INT.                  |
| 8   | SPI_SLV_CMD7_INT_RAW          | The raw interrupt status of SPI_SLV_CMD7_INT.                              |
| 7   | SPI_SLV_CMD9_INT_RAW          | The raw interrupt status of SPI_SLV_CMD9_INT.                              |
| 6   | SPI_SLV_CMD8_INT_RAW          | The raw interrupt status of SPI_SLV_CMD8_INT.                              |
| 5   | SPI_SLV_EN_QPI_INT_RAW        | The raw interrupt status of SPI_SLV_EN_QPI_INT.                            |
| 4   | SPI_SLV_EX_QPI_INT_RAW        | The raw interrupt status of SPI_SLV_EX_QPI_INT.                            |
