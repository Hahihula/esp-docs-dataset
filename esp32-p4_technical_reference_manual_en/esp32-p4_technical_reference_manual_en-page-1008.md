...
```markdown
Register 14.8. PMU_HP_ACTIVE_SYSCLK_REG (0x0024)
...
PMU_HP_ACTIVE_ICG_SYS_CLOCK_EN Configures whether to enable ROOT_CLK in HP_ACTIVE state.
O: Disable
1: Enable
(R/W)
...
PMU_HP_ACTIVE_DIG_SYS_CLK_SEL Configures the source of ROOT_CLK in HP_ACTIVE state.
O: XTAL
1: PLL_CLK
2: RC_FAST_CLK
3: Invalid value
