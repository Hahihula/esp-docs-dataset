...
When SCL_FSM remains unchanged for more than 2^I2C_SCL_ST_TO_I2C+1 -1 clock cycles, an I2C_SCL_ST_TO_INT interrupt is triggered, and then SCL_FSM goes to idle state. The value of I2C_SCL_ST_TO_I2C should be less than or equal to 23, which means SCL_FSM could remain unchanged for 2^24 -1 I2C_SCL clock cycles at most before the interrupt is generated.

When SCL_MAIN_FSM remains unchanged for more than 2^I2C_SCL_MAIN_ST_TO_I2C+1 -1 I2C_SCL clock cycles, an I2C_SCL_MAIN_ST_TO_INT interrupt is triggered, and then SCL_MAIN_FSM goes to idle state. The value of I2C_SCL_MAIN_ST_TO_I2C should be less than or equal to 23, which means SCL_MAIN_FSM could remain unchanged for 2^24 -1 clock cycles at most before the interrupt is generated.
