...
```markdown
Register 55.1. LEDC_CHn_CONFO_REG (n: 0-7) (0x0000+0x14*n)
...
Register 55.2. LEDC_CHn_HPOINT_REG (n: 0-7) (0x0004+0x14*n)
...
Register 55.3. LEDC_CHn_DUTY_REG (n: 0-7) (0x0008+0x14*n)
