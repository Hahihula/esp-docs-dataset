...
```markdown
Figure 34.6-2. ECDHO Deploy Mode
...
* NIST-P256 curve is used in the ECDHO mode, all the ECC point multiplication is calculated on NIST-P256 curve.
