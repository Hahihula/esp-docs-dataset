...
MCPWM_EVT_TZO_CBC_EN   Configures whether to enable cycle by cycle trip0 event generation.
    0: Disable
    1: Enable
    (R/W)
...
MCPWM_EVT_TZO_OST_EN   Configures whether to enable one shot trip0 event generation.
    0: Disable
    1: Enable
    (R/W)
