...
```markdown
Register 42.87. UHCI_REG_Q6_WORDO_REG (0x0064)

UHCI_SEND_Q6_WORDO Data to be transmitted in Q6 register. (R/W)


Register 42.88. UHCI_REG_Q6_WORD1_REG (0x0068)

UHCI_SEND_Q6_WORD1 Data to be transmitted in Q6 register. (R/W)


Register 42.89. UHCI_ESC_CONFQ_REG (0x006C)
