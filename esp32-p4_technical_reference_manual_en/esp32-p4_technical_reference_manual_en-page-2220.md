...
Table 43.5-11. Sending Sequence of Command Value
...
³ SPI_WR_BIT_ORDER: O: LSB first; 1: MSB first.

The configuration of address value is as follows:

Table 43.5-12. Sending Sequence of Address Value
