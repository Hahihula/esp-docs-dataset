...
- **ESP32-P4 Product/Process Change Notifications (PCN)**  
  https://espressif.com/en/support/documents/pcns?key=ESP32-P4
- **ESP32-P4 Advisories** – Information on security, bugs, compatibility, component reliability.  
  https://espressif.com/en/support/documents/advisories?key=ESP32-P4
...
- See the tabs SDKs and Demos, Apps, Tools, AT Firmware.  
  https://espressif.com/en/support/download/sdksdemos
