...
|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
|        |        |        |        |        |        |        |        |        |        |        |        |        |        |        | Reset  |
| USB_SERIAL_JTAG_JTAG_IN_FLUSH_INT_ST | The masked interrupt status of USB_SERIAL_JTAG_IN_FLUSH_INT. (RO) |
...
| USB_SERIAL_JTAG_CRC5_ERR_INT_ST      | masked interrupt status of USB_SERIAL_JTAG_CRC5_ERR_INT. (RO) |
