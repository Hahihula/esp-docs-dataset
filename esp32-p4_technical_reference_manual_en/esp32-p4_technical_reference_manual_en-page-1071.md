...
Register 15.2. SYSTIMER_UNITO_OP_REG (0x0004)
...
SYSTIMER_TIMER_UNITO_UPDATE Configures whether to update timer UNITO, i.e.,
reads the UNITO count value to SYSTIMER_TIMER_UNITO_VALUE_HI and SYS-
