...
### 34.6.1.1 HUK Generation Process
...
The modes above are jointly controlled by the eFuse field EFUSE_KM_HUK_GEN_STATE, and the register HUK_MODE, as shown in the following table.



Table 34.6-1. HUK Generator Working Mode
