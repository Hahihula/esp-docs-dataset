...
```markdown
transfer finishes and an I2C_END_DETECT_INT interrupt is detected, the cmd box is configured as shown in Segment2. Once I2C_TRANS_START is set, I2C_master terminates the transfer by sending a STOP bit.
...
5. Write the address of I2C_slave to TX RAM of I2C_master in FIFO or non-FIFO mode.
...
9. Start I2C_slave’s transfer according to Section 44.4.14.
