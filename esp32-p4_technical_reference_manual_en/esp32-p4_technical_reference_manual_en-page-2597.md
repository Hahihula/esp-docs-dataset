...
| 31  | (reserved)                                 |                                                                             |
| 31-24 |                                     |                                                                             |
| 23  | USB_SERIAL_JTAG_OUT_EP1_WR_ADDR           | Represents write data address of OUT endpoint 1.                            |
| 22  | USB_SERIAL_JTAG_OUT_EP1_RD_ADDR           | Represents read data address of OUT endpoint 1.                             |
| 15  | USB_SERIAL_JTAG_OUT_EP1_REC_DATA_CNT      | Represents data count in OUT endpoint 1 when one packet is received. (RO)   |
| 9   |                                     |                                                                             |
| 8   |                                     |                                                                             |
| 2   |                                     |                                                                             |
| 1   |                                     |                                                                             |
| 0   | USB_SERIAL_JTAG_OUT_EP1_STATE             | Represents state of OUT Endpoint 1. (RO)                                    |
...
| 31  | (reserved)                                 |                                                                             |
| 31-24 |                                     |                                                                             |
| 23  | USB_SERIAL_JTAG_OUT_EP2_WR_ADDR           | Represents write data address of OUT endpoint 2.                            |
| 22  | USB_SERIAL_JTAG_OUT_EP2_RD_ADDR           | Represents read data address of OUT endpoint 2.                             |
| 15  |                                     |                                                                             |
| 9   |                                     |                                                                             |
| 8   |                                     |                                                                             |
| 2   |                                     |                                                                             |
| 1   |                                     |                                                                             |
| 0   | USB_SERIAL_JTAG_OUT_EP2_STATE             | Represents state of OUT Endpoint 2. (RO)                                    |
