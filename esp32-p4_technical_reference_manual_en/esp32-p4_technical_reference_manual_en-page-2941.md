...
```markdown
Register 58.19. PARL_IO_TX_CLK_CFG_REG (0x0048)

| 31 | 30 | 29 | ... | 0 |
|----:|----:|----:|-----|---|
|   0 |   0 |   0 | ... |   0 |

PARL_IO_TX_CLK_O_INV Configures whether to invert the TX input Core clock.
O: No effect
1: Invert
(R/W)

PARL_IO_TX_CLK_I_INV Configures whether to invert the TX output Core clock.
O: No effect
1: Invert
(R/W)
```
...
```markdown
Register 58.20. PARL_IO_TX_CS_CFG_REG (0x004C)
