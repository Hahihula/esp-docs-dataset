...
T₁stpulse = T_PWM_clk × 8 × (MCPWM_CARRIERn_PRESCALE + 1) × (MCPWM_CARRIERn_OSHTWTH + 1)
...
The first one-shot pulse and subsequent sustaining pulses are shown in Figure 56.3-27.

Figure 56.3-27. Example of the First Pulse and the Subsequent Sustaining Pulses of the PWM Carrier Sub-module
