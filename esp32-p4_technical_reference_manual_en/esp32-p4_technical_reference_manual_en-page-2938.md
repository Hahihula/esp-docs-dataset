...
```markdown
Register 58.12. PARL_IO_INT_RAW_REG (0x002C)

PARL_IO_TX_FIFO_REMPTY_INT_RAW   The raw interrupt status of TX_FIFO_REMPTY_INT.
(R/WTC/SS)
...
Register 58.13. PARL_IO_INT_ST_REG (0x0030)
