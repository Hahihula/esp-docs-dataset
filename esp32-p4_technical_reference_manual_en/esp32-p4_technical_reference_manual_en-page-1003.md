...
```markdown
Register 14.3. PMU_HP_ACTIVE_HP_SYS_CNTL_REG (0x0010)
...
| 27  | PMU_HP_ACTIVE_HP_PAD_HOLD_ALL             | Configures whether to hold LP GPIO's configuration in HP_ACTIVE state.      |
| 26  | PMU_HP_ACTIVE_LP_PAD_HOLD_ALL             | Configures whether to hold GPIO's configuration in HP_ACTIVE state.         |
...
Configures whether to stall the CPU in HP_ACTIVE state.
O: Do not stall
1: Stall
(R/W)
```