...
## 42.4.5 AT_CMD Character Structure

Figure 42.4-4. AT_CMD Character Structure

![AT_CMD Character Structure Diagram](#)

Figure 42.4-4 is the structure of a special character AT_CMD. If the receiver constantly receives AT_CMD_CHAR and the following conditions are met, a UART_AT_CMD_CHAR_DET_INT interrupt is generated.
