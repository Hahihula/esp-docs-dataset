...
CPU_GPIO_OUT Configures GPIO[n (n=0 ~ 21)] output value. It is a CPU CSR to write value (1=high, 0=low) to SoC GPIO pin. The value takes effect only when CPU_GPIO_OEN is set.
