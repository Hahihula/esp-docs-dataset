...
**Table Title:** Table 6-3 – cont'd from previous page
...
**Note:** EVM is measured at the corresponding typical TX power provided in Table 6-2 RX Power with Spectral Mask and EVM Meeting 802.11 Standards above.

---

**Subtitle: Wi-Fi RF Receiver (RX) Characteristics**

For RX tests, the PER (packet error rate) limit is 8% for 802.11b, and 10% for 802.11g/n.

---

**Table Title:** Table 6-4. RX Sensitivity
...
*Note:* The text "Cont'd on next page" indicates that the table continues onto another page, which is not shown in this image.
