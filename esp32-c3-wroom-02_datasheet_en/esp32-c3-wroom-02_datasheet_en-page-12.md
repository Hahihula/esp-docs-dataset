...
Note:
The content below is excerpted from ESP32-C3 Series Datasheet > Section Boot Configurations. For the strapping pin mapping between the chip and modules, please refer to Chapter 8 Module Schematics.
...
eFuse parameters:
- EFUSE	UART_PRINT_CONTROL and EFUSE_B_PRINT_CHANNEL
...
Link Texts within Body:

- ESP32-C3 Series Datasheet (hyperlinked)
- Chapter Boot Configurations (hyperlinked)

Hyperlinks referenced at the bottom of page are not included in this transcription.