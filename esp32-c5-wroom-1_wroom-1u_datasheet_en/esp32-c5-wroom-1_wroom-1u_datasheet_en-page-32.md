...
| T STORAGE | Storage temperature | -40  | 105   | °C   |
...
| I VDD  | Current delivered by external power supply | —   | —    | A    |
...
| V VOL²         | Low-level output voltage      | —     | 0.1 × VDD¹ | V |
| I_OH           | High-level source current (VDD = 3.3 V, V VOL >= 2.64 V, PAD_DRIVER = 3) | —    | 40    | mA   |
| I_OL           | Low-level sink current (VDD = 3.3 V, V VOL = 0.495 V, PAD_DRVIVER = 3) | —    | 28    | mA   |
...
Espressif Systems  
Page number: **32**  
Document version: ESP32-C5-WROOM-1 & WROOM-1U Datasheet v0.8  
