...
- Page number at the bottom of each section.
- "37 ESP32-C5-WROOM-1 & WROOM-1U Datasheet v0.8"
- Link to submit documentation feedback.

Note: The text contains references to external links which are indicated by "[#]" in this transcription, but they should be represented as hyperlinks if applicable within the actual document or webpage context where it is viewed online.
PRELIMINARY

[ESP RF Test Tool](#) (This appears twice with a link symbol [#])
[Test Guide](#)

¹ Note: There seems to be an error here; "Table 7-3" should likely refer back as Table 7-2, but the content of this table is repeated from what was described in Section Title. This might indicate that there's additional information or context missing which would clarify why it appears twice.
