...
- **Joint Download Boot O mode supports the following download methods:**
  - USB-Serial-JTAG Download Boot
  - UART Download Boot

- **Joint Download Boot B mode (chip revision v0.1 only):**

- **Joint Download Boot I mode supports the following download methods:**
  - UART Download Boot
  - SDIO Download Boot
...
| | GPIO25 | MTDI |
|---|--------|------|
| Falling edge sampling, falling edge output | O | 0    |
| Rising edge sampling, rising edge output | 1 | 0    |
| Rising edge sampling, rising edge output | 1 | 1    |

**Note:** GPIO25 and MTDI are floating by default. So above configurations.
...
18 ESP32-C5-WROOM-1 & WROOM-1U Datasheet v0.8
