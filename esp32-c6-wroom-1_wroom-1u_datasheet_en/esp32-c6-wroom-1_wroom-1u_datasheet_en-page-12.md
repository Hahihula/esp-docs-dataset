...
The default values of all the above eFuse parameters are O, which means that they are not burnt. Given that eFuse is one-time programmable, once programmed to 1, it can never be reverted to 0. For how to program eFuse parameters, please refer to ESP32-C6 Technical Reference Manual > Chapter eFuse Controller.
...
**Footer:**
Espressif Systems  
12 ESP32-C6-WROOM-1 & WROOM-1U Datasheet v1.4  
