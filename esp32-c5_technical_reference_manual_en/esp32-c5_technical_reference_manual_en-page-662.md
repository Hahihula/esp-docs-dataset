...
The timer consists of two counters: UNIT0 and UNIT1. The count values can be monitored by three comparators, COMPO, COMP1, and COMP2. See the timer block diagram in Figure 14.3-1.
