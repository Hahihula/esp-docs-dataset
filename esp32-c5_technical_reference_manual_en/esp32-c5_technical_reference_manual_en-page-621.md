...
| 27  | PMU_HP_ACTIVE_LP_PAD_HOLD_ALL       | Configures whether to hold LP GPIO's configuration in HP_ACTIVE state.      |
| 26  | PMU_HP_ACTIVE_HP_PAD_HOLD_ALL       | Configures whether to hold GPIO's configuration in HP_ACTIVE state.         |
