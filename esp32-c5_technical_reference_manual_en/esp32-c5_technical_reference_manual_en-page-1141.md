...
*   0x7 (CMD7): used to generate an `SPI_SLV_CMD7_INT` interrupt. It can also generate a `AHB_DMA_IN_SUC_EOF_ChN_INT` interrupt in a slave segmented transfer when GDMA RX link is used. But it will not end GP-SPI2's slave segmented transfer.
