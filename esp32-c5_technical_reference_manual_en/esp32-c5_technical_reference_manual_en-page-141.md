...
|                |           | An array of bits indicating whether branches are taken or not. Bit 0 represents the oldest branch instruction executed. For each bit:<ul><li>0: branch taken</li><li>1: branch not taken</li></ul>|
| branch_map     |           |                                                                             |
