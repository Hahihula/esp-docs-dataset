...
| Command registers of I2Cmaster | op_code | ack_value | ack_exp | ack_check_en | byte_num |
|---------------------------------|---------|-----------|---------|--------------|----------|
| I2C_COMMANDO (master)          | READ    | 0         | 0       |              | M-1      |
| I2C_COMMAND1 (master)          | READ    | 1         | 0       | 1            | —        |
...
24. I2Cmaster executes the STOP command to stop transfer, and generates an I2C_TRANS_COMPLETE_INT (master) interrupt.
```