...
Figure 34.7-8. I2Cmaster Reading I2Cslave with a 7-bit Address in Segments

Figure 34.7-8 shows how I2Cmaster reads (N+M) bytes of data from an I2C slave in two/three segments separated by END commands. Configuration procedures are described as follows:
