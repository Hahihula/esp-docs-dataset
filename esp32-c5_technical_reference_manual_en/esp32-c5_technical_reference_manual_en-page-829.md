...
MEM_MONITOR_LOG_MON_ADDR_DMA_O_UPDATE Configures whether to update the monitored address space of the DMA_0 bus as the address space from MEM_MONITOR_LOG_MIN_REG to MEM_MONITOR_LOG_MAX_REG.
O: Not update
1: Update
