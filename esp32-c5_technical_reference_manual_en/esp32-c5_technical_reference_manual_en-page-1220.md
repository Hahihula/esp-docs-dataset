...
```markdown
I2Cmaster writes received data into the controller RAM from addr0, whose original content (the address of I2Cslave and a R/W bit) is overwritten by byte0 marked red in Figure 34.7-5.
...
5. Write the address of I2Cslave to TX RAM of I2Cmaster in either FIFO mode or non-FIFO mode according to Section 34.4.10.
...
9. Start I2Cslave’s transfer according to Section 34.4.14.
...
12. Write data to be sent to TX RAM of I2Cslave in either FIFO mode or non-FIFO mode according to Section 34.4.10.
