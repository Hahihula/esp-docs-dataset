...
| 0x01000-0x017FF  | CIS Area<br>(common and per-function) |
| 0x01800-0x01FFFF  | RFU |
...
| 0x02    | I/O Enable                 |       | O (IOE[7:3]) | R/W   | O     | (IOE[2:1]) | RFU   |
| 0x03    | I/O Ready                  |       | O (IOR[7:3]) | R     | O     | (IOR[2:1]) | RFU   |
| 0x04    | Int Enable                 |       | O (IEN[7:3]) | R/W   | R/W   | (IEN[2:1]) | IENM   |
| 0x05    | Int Pending                |       | O (INT[7:3]) | R     | O     | (INT[2:1]) | RFU   |
| 0x06    | I/O Abort                  |       | O (RFU) | W     | W     | (RES)      | AS[2:0] |
