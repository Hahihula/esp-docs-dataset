...
```markdown
| Temporary disable JTAG 3,4 | EFUSE_DIS_USB_JTAG 4 | EFUSE_DIS_USB_SERIAL_JTAG 4 | EFUSE_DIS_PAD_JTAG 4 | EFUSE_JTAG_SEL_ENABLE 4 | Strapping in GPIO7 5 | USB JTAG Status | PAD JTAG Status |
|----------------------------|----------------------|------------------------------|-----------------------|--------------------------|----------------------|------------------|------------------|
| 0                          | 0                    | 0                            | 0                     | 0                        | x2                   | Available 1      | Unavailable 1    |
| 0                          | 0                    | 0                            | 0                     | 1                        | 1                    | Available        | Unavailable      |
| 0                          | 0                    | 0                            | 1                     | 0                        | 0                    | Unavailable      | Available        |
...
| 1                          | x                    | x                            | x                     | x                        |                      | Unavailable      | Unavailable      |
