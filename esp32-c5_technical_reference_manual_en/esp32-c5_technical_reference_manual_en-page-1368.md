...
| 24  | USB_SERIAL_JTAG_USB_BUS_RESET_INT_CLR      | Write 1 to clear USB_SERIAL_JTAG_USB_BUS_RESET_INT. (WT)                    |
| 23  | USB_SERIAL_JTAG_IN_TOKEN_REC_IN_EP1_INT_CLR | Write 1 to clear USB_SERIAL_JTAG_IN_TOKEN_REC_IN_EP1_INT. (WT)             |
| 22  | USB_SERIAL_JTAG_IN_STUFF_ERR_INT_CLR       | Write 1 to clear USB_SERIAL_JTAG_STUFF_ERR_INT. (WT)                        |
...
| 19  | USB_SERIAL_JTAG_IN_EMPTY_INT_CLR           | Write 1 to clear USB_SERIAL_JTAG_IN_EMPTY_INT. (WT)                         |
| 18  | USB_SERIAL_JTAG_OUT_RECV_PKT_INT_CLR       | Write 1 to clear USB_SERIAL_JTAG_OUT_RECV_PKT_INT. (WT)                     |
| 17  | USB_SERIAL_JTAG_IN_FLUSH_INT_CLR           | Write 1 to clear USB_SERIAL_JTAG_IN_FLUSH_INT. (WT)                         |
| 16  |                                            |                                                                             |

USB_SERIAL_JTAG_JTAG_IN_FLUSH_INT_CLR   Write 1 to clear USB_SERIAL_JTAG_JTAG_IN_FLUSH_INT.
(WT)

USB_SERIAL_JTAG_SOF_INT_CLR               Write 1 to clear USB_SERIAL_JTAG_SOF_INT. (WT)

USB_SERIAL_JTAG_SERIAL_OUT_RECV_PKT_INT_CLR Write 1 to clear
USB_SERIAL_JTAG_SERIAL_OUT_RECV_PKT_INT. (WT)

USB_SERIAL_JTAG_SERIAL_IN_EMPTY_INT_CLR   Write 1 to clear
USB_SERIAL_JTAG_SERIAL_IN_EMPTY_INT. (WT)
