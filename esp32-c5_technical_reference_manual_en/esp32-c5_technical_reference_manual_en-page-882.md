...
Reading data means reading data from the starting address of an ECC memory block and using this data as the output from the ECC algorithm. To be specific, reading data from an ECC memory block means reading D[n][31:0](n = 0, 1, ··· , 11) from the "starting address of this ECC memory block + 4 × n" successively:
