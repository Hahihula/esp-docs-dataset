...
SOC_ETM_TGO_TASK_CNT_RELOAD_TIMERO_ST_CLR Configures whether or not to clear TGO_TASK_CNT_RELOAD_TIMERO trigger status.
O: Invalid. No effect
1: Clear
(WT)

SOC_ETM_TGO_TASK_CNT_CAP_TIMERO_ST_CLR Configures whether or not to clear TGO_TASK_CNT_CAP_TIMERO trigger status.
O: Invalid. No effect
1: Clear
(WT)
