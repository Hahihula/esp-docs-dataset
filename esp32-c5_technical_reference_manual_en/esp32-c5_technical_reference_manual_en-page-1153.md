...
|----------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|
| SPI_DMA_SEG_TRAN_DONE_INT                   | At the end of End_SEG_TRAN transfer in GP-SPI2 slave segmented transfer mode or at the end of master configurable segmented transfer mode                                                                                                 | SPI_INTR        |
...
|                                   |                          | CPU           | SPI_TRANS_DONE_INT                                                      |
|                                   | Half-duplex MISO Mode    | DMA           | AHB_DMA_IN_SUC_EOF_CHn_INT                                              |
|                                   |                          | CPU           | SPI_TRANS_DONE_INT                                                      |
| Configurable Segmented Transfer   | Full-duplex              | DMA           | SPI_DMA_SEG_TRAN_DONE_INT³                                             |
|                                   |                          | CPU           | Not supported                                                            |
|                                   | Half-duplex MOSI Mode    | DMA           | SPI_DMA_SEG_TRAN_DONE_INT                                               |
|                                   |                          | CPU           | Not supported                                                            |
|                                   | Half-duplex MISO         | DMA           | SPI_DMA_SEG_TRAN_DONE_INT                                               |
|                                   |                          | CPU           | Not supported                                                            |
```