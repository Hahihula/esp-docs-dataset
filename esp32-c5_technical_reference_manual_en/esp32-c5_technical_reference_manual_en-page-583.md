...
```markdown
SOC_ETM_LEDC_TASK_OVF_CNT_RST_CHO_ST_CLR Configures whether or not to clear LEDC_TASK_OVF_CNT_RST_CHO trigger status.
O: Invalid. No effect
1: Clear
(WT)
...
SOC_ETM_LEDC_TASK_TIMERO_RST_ST_CLR Configures whether or not to clear LEDC_TASK_TIMERO_RST trigger status.
O: Invalid. No effect
1: Clear
(WT)
```
