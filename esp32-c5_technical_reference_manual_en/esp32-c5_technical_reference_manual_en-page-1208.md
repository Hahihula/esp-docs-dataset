...
I2C_FIFO_PRT_EN. If the size of data to be sent is smaller than I2C_TXFIFO_WM_THRDH (master), an
...
than I2C_RXFIFO_WM_THRDH (slave), an I2C_RXFIFO_WM_INT (slave) interrupt is generated. After receiving
...
The ESP32-C5 I2C controller supports 7-bit and 10-bit addressing. 10-bit addressing can be mixed with 7-bit
addressing. Besides, the ESP32-C5 I2C controller also supports dual address mode.
