...
| AHB_DMA_AHBINF_RESP_ERR_STATUSO_REG       | Address of the transfer for which GDMA received an AHB bus error response                       | 0x0408  | RO     |
| AHB_DMA_AHBINF_RESP_ERR_STATUS1_REG       | Transfer type, ID, and channel ID of the transfer for which GDMA received an AHB bus error response | 0x040C  | RO     |
