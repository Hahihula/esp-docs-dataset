...
```markdown
Register 5.33. AHB_DMA_IN_ERR_EOF_DES_ADDR_CHn_REG (n: 0-2) (0x008C+0xC0*n)
...
Register 5.34. AHB_DMA_IN_DSCR_CHn_REG (n: 0-2) (0x0090+0xC0*n)
...
Register 5.35. AHB_DMA_IN_DSCR_BFO_CHn_REG (n: 0-2) (0x0094+0xC0*n)
