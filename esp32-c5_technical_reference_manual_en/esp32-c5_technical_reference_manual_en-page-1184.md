...
SPI_DMA_SEG_TRANS_DONE_INT_ENA   Write 1 to enable the SPI_DMA_SEG_TRANS_DONE_INT
interrupt.
(R/W)
...
SPI_MST_RX_AFIFO_WFULL_ERR_INT_ENA   Write 1 to enable
the SPI_MST_RX_AFIFO_WFULL_ERR_INT interrupt.
(R/W)

SPI_MST_TX_AFIFO_REMPTY_ERR_INT_ENA   Write 1 to enable
the SPI_MST_TX_AFIFO_REMPTY_ERR_INT interrupt.
(R/W)
