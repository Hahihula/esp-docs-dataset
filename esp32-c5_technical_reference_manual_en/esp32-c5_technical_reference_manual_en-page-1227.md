...
15. If data to be read by `I2Cmaster` in one READ command (N or M) is larger than the TX FIFO depth of `I2Cslave`, an `I2C_SLAVE_STRETCH_INT` (slave) interrupt will be generated when TX RAM of `I2Cslave` becomes
```