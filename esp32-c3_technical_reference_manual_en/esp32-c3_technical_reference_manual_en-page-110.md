...
• Method one:
    ...
    1. Poll bit I/O in register EFUSE_INT_RAW_REG until it becomes 1, which represents the completion of a program/read operation.

• Method two:

    1. Set bit I/O in register EFUSE_INT_ENA_REG to 1 to enable the eFuse Controller to post a PGM/READ_DONE interrupt.
    ...
    4. Set bit I/O in register EFUSE_INT_CLR_REG to 1 to clear the PGM/READ_DONE interrupt.
