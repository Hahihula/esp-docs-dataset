...
*   "IN": data input path of GP-SPI2. The input data from an external SPI device passes through GPIO Matrix or IO MUX, then is adjusted by the Timing Module and finally is stored into spi_rx_affifo.
...
![Figure 27.8-1. Timing Compensation Control Diagram in GP-SPI2 Master Mode](image)
