...
In Typical AES working mode, the AES Accelerator uses cryptographic keys to encrypt and decrypt data in blocks of 128 bits. When filling data into `AES_TEXT_IN_m_REG` register or reading result from `AES_TEXT_OUT_m_REG` registers, users should follow the text endianness type specified in Table 18.4-2.

Table 18.4-2. Text Endianness Type for Typical AES

| State¹ | Plaintext/Ciphertext | c² |
|--------|----------------------|----|
|        |                      |    |
|        | 0                    | 1  | 2   | 3   |
| r      | 0                    | `AES_TEXT_x_O_REG[7:0]` | `AES_TEXT_x_1_REG[7:0]` | `AES_TEXT_x_2_REG[7:0]` | `AES_TEXT_x_3_REG[7:0]` |
|        | 1                    | `AES_TEXT_x_O_REG[15:8]` | `AES_TEXT_x_1_REG[15:8]` | `AES_TEXT_x_2_REG[15:8]` | `AES_TEXT_x_3_REG[15:8]` |
|        | 2                    | `AES_TEXT_x_O_REG[23:16]` | `AES_TEXT_x_1_REG[23:16]` | `AES_TEXT_x_2_REG[23:16]` | `AES_TEXT_x_3_REG[23:16]` |
|        | 3                    | `AES_TEXT_x_O_REG[31:24]` | `AES_TEXT_x_1_REG[31:24]` | `AES_TEXT_x_2_REG[31:24]` | `AES_TEXT_x_3_REG[31:24]` |
