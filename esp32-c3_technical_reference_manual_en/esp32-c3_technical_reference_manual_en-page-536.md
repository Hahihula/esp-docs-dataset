...
*   `BlockA`: the block whose key purpose is EFUSE_KEY_PURPOSE_XTS_AES_128_KEY (please refer to Table 4.3-2 Secure Key Purpose Values). The 256-bit `KeyA` is stored in it.
