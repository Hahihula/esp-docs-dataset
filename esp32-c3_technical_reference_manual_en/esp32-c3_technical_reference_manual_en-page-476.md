...
In Typical AES working mode, when filling key into `AES_KEY_m_REG` registers, users should follow the key endianness type specified in Table 18.4-3 and Table 18.4-4.
