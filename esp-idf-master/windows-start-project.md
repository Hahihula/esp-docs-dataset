---
original_file_path: get-started/windows-start-project.rst
---
...
## Activate the Environment {#get-started-set-up-env}
...
This section describes the default and recommended procedures to activate the environment from ESP-IDF v6.0. If you use the `legacy method for updating ESP-IDF tools <windows-setup-update-legacy>`{.interpreted-text role="doc"}, skip this section.
::::
...
## Connect Your Device {#get-started-connect}
...
## Configure Your Project {#get-started-configure}
