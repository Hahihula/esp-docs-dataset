---
original_file_path: api-guides/file-system-considerations.rst
---
...
+==========================+==================================================================================================+================================================================================+=========================================================================================================================+
| Features                 | - Implements MS FAT12, FAT16, FAT32 and optionally exFAT variants                                | - Developed for NOR flash devices on embedded systems, low RAM usage           | - Designed as fail-safe, with own wear levelling and with fixed amount of RAM usage independent on the file system size |
|                          | - General purpose filesystem, widely compatible across most HW platforms                         | - Implements static wear levelling                                             | - Well documented                                                                                                       |
|                          | - Well documented                                                                                | - Limited documentation, no ongoing development                                | - Thread safe                                                                                                           |
|                          | - Thread safe                                                                                    | - Thread safe                                                                  |                                                                                                                         |
+--------------------------+--------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+
| Storage units and limits | - Clusters (1--128 sectors)                                                                      | - Logical pages, logical blocks (consists of pages)                            | - Blocks, metadata pairs                                                                                                |
|                          | - Supported sector sizes: 512 B, 4096 B                                                          | - Typical setup: page = 256 B, block = 64 kB                                   | - Typical block size: 4 kB                                                                                              |
...
+--------------------------+--------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+
| Minimum partition size   | - 8 sectors with wear levelling on (4 FATFS sectors + 4 WL sectors with WL sector size = 4096 B) | - 6 logical blocks                                                             | Not specified, theoretically 2 blocks                                                                                   |
|                          | - plus 4 sectors at least                                                                        | - 8 pages per block                                                            |                                                                                                                         |
|                          | - real number given by WL configuration (Safe, Perf)                                             |                                                                                |                                                                                                                         |
+--------------------------+--------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+
| Maximum partition size   | - FAT12: approx. 32 MB with 8 kB clusters                                                        | Absolute maximum not specified, more than 1024 pages per block not recommended | Not specified, theoretically around 2 GB                                                                                |
|                          | - FAT16: approx. 4 GB with 64 kB clusters (theoretical)                                          |                                                                                |                                                                                                                         |
|                          | - FAT32: approx. 8 TB with 32 kB clusters (theoretical)                                          |                                                                                |                                                                                                                         |
+--------------------------+--------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+
| Directory Support        | - Yes (max 65536 entries in a common FAT directory)                                              | No                                                                             | Yes                                                                                                                     |
|                          |                                                                                                  |                                                                                |                                                                                                                         |
|                          | -                                                                                                |                                                                                |                                                                                                                         |
|                          |                                                                                                  |                                                                                |                                                                                                                         |
|                          |   Limitations:                                                                                   |                                                                                |                                                                                                                         |
...
+--------------------------+--------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+
| Power failure protection | No                                                                                               | Partial (see `spiffs-fs-section`{.interpreted-text role="ref"})                | Yes (integrated)                                                                                                        |
+--------------------------+--------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+
| Encryption support       | Yes                                                                                              | No                                                                             | Yes                                                                                                                     |
+--------------------------+--------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+
| Supported targets        | - SPI Flash (NOR)                                                                                | SPI Flash (NOR)                                                                | - SPI Flash (NOR)                                                                                                       |
|                          | - SD cards                                                                                       |                                                                                | - SD cards (IDF \>= v5.0)                                                                                               |
+--------------------------+--------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+

For file systems performance comparison using various configurations and parameters, see Storage performance benchmark example `storage/perf_benchmark`{.interpreted-text role="example"}.

## FatFS {#fatfs-fs-section}

The most supported file system, recommended for common applications - file/directory operations, data storage, logging, etc. It provides automatic resolution of specific FAT system type and is widely compatible with PC or other platforms. FatFS supports partition encryption, read-only mode, optional wear-levelling for SPI Flash (SD cards use own built-in WL), equipped with auxiliary host side tools (generators and parsers, Python scripts). It supports SDMMC access. The biggest weakness is its low resilience against sudden power-off events. To mitigate such a scenario impact, the ESP-IDF FatFS default setup deploys 2 FAT table copies. This option can be disabled by setting `esp_vfs_fat_mount_config_t::use_one_fat`{.interpreted-text role="cpp:member"} flag (the 2-FAT processing is fully handled by the FatFS library). See also related examples.
...
- `Using FatFS with VFS <using-fatfs-with-vfs>`{.interpreted-text role="ref"}
- `Using FatFS with VFS and SD cards <using-fatfs-with-vfs-and-sdcards>`{.interpreted-text role="ref"}
- ESP-IDF FatFS tools: `Partition generator <fatfs-partition-generator>`{.interpreted-text role="ref"} and `Partition analyzer <fatfs-partition-analyzer>`{.interpreted-text role="ref"}

**Examples:**

- `storage/sd_card`{.interpreted-text role="example"} demonstrates how to access the SD card that uses the FAT file system.
- `storage/fatfs/ext_flash`{.interpreted-text role="example"} demonstrates how to access the external flash that uses the FAT file system.

## SPIFFS {#spiffs-fs-section}

SPIFFS is a file system providing certain level of power-off safety (see repair-after-restart function `esp_spiffs_check`{.interpreted-text role="cpp:func"}) and built-in wear levelling. It tends to slow down when exceeding around 70% of the dedicated partition size due to its garbage collector implementation, and also doesn\'t support directories. It is useful for applications depending only on few files (possibly large) and requiring high level of consistency. Generally, the SPIFFS needs less RAM resources than FatFS and supports flash chips up to 128 MB in size. Please keep in mind the SPIFFS is not being developed and maintained anymore, so consider precisely whether its advantages for your project really prevail over the other file systems.

**Related documents:**

- `SPIFFS Filesystem <../api-reference/storage/spiffs>`{.interpreted-text role="doc"}
- `Tools For Generating SPIFFS Images <spiffs-generator>`{.interpreted-text role="ref"}

**Examples:**

- `storage/spiffs`{.interpreted-text role="example"} demonstrates how to use SPIFFS on {IDF_TARGET_NAME} chip.
...
- `storage/littlefs`{.interpreted-text role="example"} demonstrates how to use LittleFS on {IDF_TARGET_NAME} chip.

## NVS Library {#nvs-fs-section}
...
- To learn more about the API and NVS library details, see the `NVS documentation page <../api-reference/storage/nvs_flash>`{.interpreted-text role="doc"}.
- For mass production, you can use the `NVS Partition Generator Utility <../api-reference/storage/nvs_partition_gen>`{.interpreted-text role="doc"}.
- For offline NVS partition analysis, you can use the `NVS Partition Parser Utility <../api-reference/storage/nvs_partition_parse>`{.interpreted-text role="doc"}.
- For more information about read-only NVS partitions, see the `Read-only NVS <read-only-nvs>`{.interpreted-text role="ref"}.

**Examples:**

- `storage/nvs/nvs_rw_value`{.interpreted-text role="example"} demonstrates how to use NVS to write and read a single integer value.
- `storage/nvs/nvs_rw_blob`{.interpreted-text role="example"} demonstrates how to use NVS to write and read a blob.
- `storage/nvs/nvs_statistics`{.interpreted-text role="example"} demonstrates how to obtain and interpret NVS usage statistics: free/used/available/total number of entries and number of namespaces in given NVS partition.
- `storage/nvs/nvs_iteration`{.interpreted-text role="example"} demonstrates how to iterate over entries of specific (or any) NVS data type and how to obtain info about such entries.
- `security/nvs_encryption_hmac`{.interpreted-text role="example"} demonstrates NVS encryption using the HMAC peripheral, where the encryption keys are derived from the HMAC key burnt in eFuse.
- `security/flash_encryption`{.interpreted-text role="example"} demonstrates the flash encryption workflow including NVS partition creation and usage.
...
- External partition encryption can be deployed by implementing custom encrypt/decrypt code in appropriate driver APIs - either by implementing own SPI flash driver (see `storage/custom_flash_driver`{.interpreted-text role="example"}) or by customizing higher levels in the driver stack, for instance by providing own `FatFS disk IO layer <fatfs-diskio-layer>`{.interpreted-text role="ref"}.
