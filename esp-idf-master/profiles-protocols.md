---
original_file_path: api-guides/classic-bt/profiles-protocols.rst
---
...
The table below summarizes the Bluetooth Classic profiles supported by ESP-Bluedroid:
  ...
  Profile   Supported Roles      Description
  --------- -------------------- -------------------------------------------------------
  GAP       ---                  Device discovery, connection, and security management
  A2DP      Source, Sink         High-quality audio streaming
  AVRCP     Controller, Target   Audio/video remote control
  HFP       AG, HF               Hands-free voice calls
  SPP       Server, Client       Serial data transfer
...
Refer to the `GAP API </api-reference/bluetooth/esp_gap_bt>`{.interpreted-text role="doc"} for details.
...
A2DP is based on GAP and the Generic Audio/Video Distribution Profile (GAVDP), responsible for establishing audio/video streams. See `profile-dependencies`{.interpreted-text role="ref"} for dependencies.

Refer to the `A2DP API </api-reference/bluetooth/esp_a2dp>`{.interpreted-text role="doc"} for details.
...
See `profile-dependencies`{.interpreted-text role="ref"} for the dependencies between A2DP and AVRCP.

::: {#profile-dependencies}
<figure class="align-center">
<img src="../../../_static/profile-dependencies.png" style="width:50.0%" alt="Profile Dependencies" />
<figcaption aria-hidden="true">Profile Dependencies</figcaption>
</figure>
:::

Refer to the `AVRCP API </api-reference/bluetooth/esp_avrc>`{.interpreted-text role="doc"} for details.
...
Refer to the `HFP API </api-reference/bluetooth/esp_hf_defs>`{.interpreted-text role="doc"} for details.
...
Refer to the `SPP API </api-reference/bluetooth/esp_spp>`{.interpreted-text role="doc"} for details.
