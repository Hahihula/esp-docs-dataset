---
original_file_path: api-reference/storage/fatfsgen.rst
---
...
This document is intended mainly for developers of Python tools `fatfsgen.py <fatfs/fatfsgen.py>`{.interpreted-text role="component_file"} and `fatfsparse.py <fatfs/fatfsparse.py>`{.interpreted-text role="component_file"}, and people with special interest in these tools and implementation of the FAT file system in ESP-IDF. If you are interested in using these tools, please refer to the user guide at `fatfs-partition-generator`{.interpreted-text role="ref"}.
...
<img src="../../../_static/classes_fatfsgen.svg" alt="Class diagram" />
...
<figure class="align-center">
<img src="../../../_static/fat_table.svg" alt="Table diagram" />
</figure>
...
<figure class="align-center">
<img src="../../../_static/tree_fatfs.svg" alt="Tree diagram" />
</figure>

## `fatfsgen.py`

`fatfsgen.py <fatfs/fatfsgen.py>`{.interpreted-text role="component_file"} generates FAT file systems on the host.
...
There exist two scripts for that purpose, `fatfsgen.py <fatfs/fatfsgen.py>`{.interpreted-text role="component_file"} and `wl_fatfsgen.py <fatfs/wl_fatfsgen.py>`{.interpreted-text role="component_file"}. The difference is that `wl_fatfsgen.py` firstly uses `fatfsgen.py` for generating the partition and then initializes wear leveling.
...
### Wear Levelling {#fafsgen-wear-levelling}
...
- `storage/fatfs/fatfsgen`{.interpreted-text role="example"} demonstrates how to use the FatFS partition generation tool to automatically create a FatFS image from a host folder during the building process.
