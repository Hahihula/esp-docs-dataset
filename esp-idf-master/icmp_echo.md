---
original_file_path: api-reference/protocols/icmp_echo.rst
---
...
- `protocols/icmp_echo`{.interpreted-text role="example"} demonstrates how to implement a simple ping command line utility to test if a remote host is reachable on the IP network, using ICMP echo request packets.
