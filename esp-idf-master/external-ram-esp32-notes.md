---
original_file_path: api-guides/inc/external-ram-esp32-notes.rst
---
...
ESP32 rev v3.0 fixes the PSRAM cache issue found in rev v1.0. When `CONFIG_ESP32_REV_MIN`{.interpreted-text role="ref"} option is set to `rev v3.0`, compiler workarounds related to PSRAM will be disabled. For more information about ESP32 v3.0, see [ESP32 Chip Revision v3.0 User Guide]().
