---
original_file_path: api-reference/bluetooth/esp-ble-mesh.rst
---
...
For information how to start using ESP32 and ESP-BLE-MESH, please see the Section `getting-started-with-ble-mesh`{.interpreted-text role="ref"}. If you are interested in information on ESP-BLE-MESH architecture, including some details of software implementation, please see Section `../../api-guides/esp-ble-mesh/ble-mesh-architecture`{.interpreted-text role="doc"}.

## Application Examples and Demos

Please refer to Sections `esp-ble-mesh-examples`{.interpreted-text role="ref"} and `esp-ble-mesh-demo-videos`{.interpreted-text role="ref"}.
