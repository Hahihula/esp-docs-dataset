...
- `wifi/wifi_easy_connect/dpp-enrollee`{.interpreted-text role="example"} demonstrates how to configure {IDF_TARGET_NAME} as an enrollee using DPP to securely onboard ESP devices to a network with the help of a QR code and an Android 10+ device.
