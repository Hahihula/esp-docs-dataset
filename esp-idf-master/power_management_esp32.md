---
original_file_path: api-reference/system/inc/power_management_esp32.rst
---
...
- - `1`{.interpreted-text role="rspan"} 240
...
- - `2`{.interpreted-text role="rspan"} 160
  - `ESP_PM_CPU_FREQ_MAX` acquired
  - \- CPU: 160 MHz - APB: 80 MHz
