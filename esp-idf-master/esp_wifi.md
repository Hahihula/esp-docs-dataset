---
original_file_path: api-reference/network/esp_wifi.rst
---
...
Several application examples demonstrating the functionality of Wi-Fi library are provided in `wifi`{.interpreted-text role="example"} directory of ESP-IDF repository. Please check the `README <wifi/README.md>`{.interpreted-text role="example_file"} for more details.
