---
original_file_path: migration-guides/release-6.x/6.0/provisioning.rst
---
...
- `CONFIG_ESP_PROTOCOMM_SUPPORT_SECURITY_VERSION_0`{.interpreted-text role="ref"} now defaults to `n` (previously `y`)
- `CONFIG_ESP_PROTOCOMM_SUPPORT_SECURITY_VERSION_1`{.interpreted-text role="ref"} now defaults to `n` (previously `y`)
...
- For security version 0: Enable `CONFIG_ESP_PROTOCOMM_SUPPORT_SECURITY_VERSION_0`{.interpreted-text role="ref"}
- For security version 1: Enable `CONFIG_ESP_PROTOCOMM_SUPPORT_SECURITY_VERSION_1`{.interpreted-text role="ref"}
