---
original_file_path: api-reference/bluetooth/esp_blufi.rst
---
...
- `bluetooth/blufi`{.interpreted-text role="example"} how to use the Blufi function to configure the Wi-Fi connection to an AP via a Bluetooth channel on {IDF_TARGET_NAME}.
