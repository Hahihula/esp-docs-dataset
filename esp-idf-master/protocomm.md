---
original_file_path: api-reference/provisioning/protocomm.rst
---
...
See `provisioning`{.interpreted-text role="doc"} for more details about the secure handshake logic.
:::
...
> - Support `protocomm_security0`, with no security: `CONFIG_ESP_PROTOCOMM_SUPPORT_SECURITY_VERSION_0`{.interpreted-text role="ref"}, this option is enabled by default.
> - Support `protocomm_security1` with Curve25519 key exchange + AES-CTR encryption/decryption: `CONFIG_ESP_PROTOCOMM_SUPPORT_SECURITY_VERSION_1`{.interpreted-text role="ref"}, this option is enabled by default.
> - Support `protocomm_security2` with SRP6a-based key exchange + AES-GCM encryption/decryption: `CONFIG_ESP_PROTOCOMM_SUPPORT_SECURITY_VERSION_2`{.interpreted-text role="ref"}.
