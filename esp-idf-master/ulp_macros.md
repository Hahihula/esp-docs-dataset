---
original_file_path: api-reference/system/ulp_macros.rst
---
...
Load, store and move instructions use **addresses expressed in 32-bit words**. Address 0 corresponds to the first word of `RTC_SLOW_MEM`. This is different from how address arguments are handled in assembly code of the same instructions. See the section `ulp-fsm-addressing`{.interpreted-text role="ref"} for more details for reference.
::::
