---
original_file_path: api-guides/wireshark-user-guide.rst
---
...
<img src="../../_static/ws-capture-interface.jpeg" style="width:60.0%" alt="Wireshark Capture Interface" />
<figcaption aria-hidden="true">Wireshark Capture Interface</figcaption>
</figure>
...
<figure class="align-center">
<img src="../../_static/ws-setup-filters.png" alt="Setting up Filters in Wireshark" />
<figcaption aria-hidden="true">Setting up Filters in Wireshark</figcaption>
</figure>

Click *Filter*, the top left blue button in the picture below. The *display filter* dialogue box will appear.

<figure class="align-center">
<img src="../../_static/ws-display-filter-dialogue-box.png" style="width:60.0%" alt="*Display Filter* Dialogue Box" />
...
<figure class="align-center">
<img src="../../_static/ws-filter-expression.png" style="width:80.0%" alt="*Filter Expression* Dialogue Box" />
...
<figure class="align-center">
<img src="../../_static/ws-filter-toolbar.png" alt="Filter Toolbar" />
<figcaption aria-hidden="true">Filter Toolbar</figcaption>
</figure>
...
<figure class="align-center">
<img src="../../_static/ws-filter-toolbar_green.png" alt="Example of MAC Addresses applied in the Filter Toolbar" />
<figcaption aria-hidden="true">Example of MAC Addresses applied in the Filter Toolbar</figcaption>
</figure>
...
<figure class="align-center">
<img src="../../_static/ws-packet-list.png" alt="Example of Packet List Details" />
<figcaption aria-hidden="true">Example of Packet List Details</figcaption>
</figure>
...
<figure class="align-center">
<img src="../../_static/ws-stop-packet-capture.png" alt="Stopping Packets Capture" />
...
<figure class="align-center">
<img src="../../_static/ws-start-resume-packet-capture.png" style="width:60.0%" alt="Starting or Resuming Packets Capture" />
...
<figure class="align-center">
<img src="../../_static/ws-save-packets.png" style="width:60.0%" alt="Saving Captured Packets" />
<figcaption aria-hidden="true">Saving Captured Packets</figcaption>
</figure>
