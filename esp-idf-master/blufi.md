---
original_file_path: api-guides/ble/blufi.rst
---
...
For new projects or when adding Wi-Fi provisioning, we recommend using the [network_provisioning](https://github.com/espressif/idf-extra-components/tree/master/network_provisioning) component, which offers a modern, secure, and actively maintained solution.
::::
...
- BluFi example: `bluetooth/blufi`{.interpreted-text role="example"} (to be flashed into {IDF_TARGET_NAME})
...
For detailed instructions on flashing BluFi example, please refer to ESP-IDF `../../get-started/index`{.interpreted-text role="doc"} documentation.
...
1.  **Power on {IDF_TARGET_NAME}**
    ...
    <img src="../../../_static/blufi-init-finish.png" style="width:70.0%" />
    </figure>
...
2.  **Connect via EspBlufi**
    ...
    - Open the EspBlufi app, and refresh the interface by swiping down. The nearby Bluetooth-enabled devices will be displayed.
      ...
      <figure class="align-center">
      <img src="../../../_static/espblufi-interface.jpg" alt="EspBlufi Interface" />
      <figcaption aria-hidden="true">EspBlufi Interface</figcaption>
      </figure>
    ...
    - Click on the {IDF_TARGET_NAME} device, and click **Connect** to establish a Bluetooth connection. A successful connection will display the following interface:
      ...
      <figure class="align-center">
      <img src="../../../_static/interface-success-connection.jpg" alt="Successful Connection" />
      <figcaption aria-hidden="true">Successful Connection</figcaption>
      </figure>

      Meanwhile, the following log will be output to the serial port tool:

      <figure class="align-center">
      <img src="../../../_static/blufi-ble-connect.png" style="width:80.0%" />
      </figure>
...
3.  **Configure Wi-Fi**
    ...
    - Click on the **Networking** button to open the network configuration menu:
      ...
      <figure class="align-center">
      <img src="../../../_static/network-config-interface.jpg" alt="Network Configuration Interface" />
      <figcaption aria-hidden="true">Network Configuration Interface</figcaption>
      </figure>
    ...
    - Select a device mode from the dropdown list. BluFi supports the following three modes:
      ...
      <figure class="align-center">
      <img src="../../../_static/select-device-mode.jpg" alt="Selecting Device Mode" />
      <figcaption aria-hidden="true">Selecting Device Mode</figcaption>
      </figure>

    - Select **Station** mode, click on the refresh button, and choose a Wi-FI SSID. Then, enter the password.

      <figure class="align-center">
      <img src="../../../_static/config-station-mode.jpg" alt="Configuring Station Mode" />
      <figcaption aria-hidden="true">Configuring Station Mode</figcaption>
      </figure>
    ...
    - Click on the **Confirm** button to complete the configuration. A successful connection will display the following interface. The information marked in red in shows the Wi-Fi mode (which is Station mode in this example) and the connection information (such as the AP's BSSID and SSID, as well as the connection status).
      ...
      <figure class="align-center">
      <img src="../../../_static/station-connection-info.jpg" alt="Station Connection Information" />
      <figcaption aria-hidden="true">Station Connection Information</figcaption>
      </figure>

      Meanwhile, the following log will be output to the serial port tool:

      <figure class="align-center">
      <img src="../../../_static/station-connection-log.png" style="width:80.0%" />
      </figure>
...
1.  **Connect via EspBlufi**
    ...
    - In the network configuration menu, select **SoftAP** mode:
      ...
      <figure class="align-center">
      <img src="../../../_static/select-softap-mode.jpg" alt="Selecting SoftAP Mode" />
      <figcaption aria-hidden="true">Selecting SoftAP Mode</figcaption>
      </figure>
...
2.  **Configure SoftAP**
    ...
    - Click on the **Confirm** button to complete the configuration.
      ...
      <figure class="align-center">
      <img src="../../../_static/config-softap-mode.jpg" alt="Configuring SoftAP Mode" />
      <figcaption aria-hidden="true">Configuring SoftAP Mode</figcaption>
      </figure>
...
3.  **Verify SoftAP**
    ...
    <figure class="align-center">
    <img src="../../../_static/softap-connection-info.jpg" alt="SoftAP Connection Information" />
    <figcaption aria-hidden="true">SoftAP Connection Information</figcaption>
    </figure>

    Meanwhile, the following log will be output to the serial port tool:

    <figure class="align-center">
    <img src="../../../_static/softap-connection-log.png" style="width:70.0%" />
    </figure>
...
4.  **Connect to SoftAP**
    ...
    - Enable Wi-Fi on your mobile phone. The configured SoftAP will appear in the network list:
      ...
      <figure class="align-center">
      <img src="../../../_static/configured-softap.png" height="370" alt="The Configured SoftAP" />
      <figcaption aria-hidden="true">The Configured SoftAP</figcaption>
      </figure>

    - Connect to the SoftAP. A successful connection will be indicated as follows:

      <figure class="align-center">
      <img src="../../../_static/wifi-connection-prompt.png" height="370" alt="Wi-Fi Connection Prompt" />
      <figcaption aria-hidden="true">Wi-Fi Connection Prompt</figcaption>
      </figure>

      Meanwhile, the following log will be output to the serial port tool:

      <figure class="align-center">
      <img src="../../../_static/wifi-connection-log.png" style="width:80.0%" />
      </figure>
...
3.  After the GATT connection is successfully established, the mobile phone will send a data frame for key negotiation to {IDF_TARGET_NAME} (see the section `frame_formats`{.interpreted-text role="ref"} for details).
...
8.  The mobile phone sends the data frame defined in the section of `frame_formats`{.interpreted-text role="ref"},with the Wi-Fi configuration information to {IDF_TARGET_NAME}, including SSID, password, etc.
...
## The Frame Formats Defined in BluFi {#frame_formats}
...
|                |                                                                        |                                                                                                                                                                                                                            |                                                                                                                                                                                                                                                       |
|                |                                                                        | If it is not set, the ESP device will send the control frame and data frame with no checksum and encryption by default. The data transmission from the mobile phone to the ESP device is controlled by this control frame. | - b'0000: no checksum and no encryption;                                                                                                                                                                                                              |
|                |                                                                        |                                                                                                                                                                                                                            | - b'0001: with checksum but no encryption;                                                                                                                                                                                                            |
|                |                                                                        |                                                                                                                                                                                                                            | - b'0010: no checksum but with encryption;                                                                                                                                                                                                            |
|                |                                                                        |                                                                                                                                                                                                                            | - b'0011: with both checksum and encryption.                                                                                                                                                                                                          |
+----------------+------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 0x2 (b'000010) | Set the opmode of Wi-Fi.                                               | The frame contains opmode settings for configuring the Wi-Fi mode of the ESP device.                                                                                                                                       | data\[0\] is for opmode settings, including:                                                                                                                                                                                                          |
|                |                                                                        |                                                                                                                                                                                                                            |                                                                                                                                                                                                                                                       |
|                |                                                                        |                                                                                                                                                                                                                            | - 0x00: NULL                                                                                                                                                                                                                                          |
|                |                                                                        |                                                                                                                                                                                                                            | - 0x01: STA                                                                                                                                                                                                                                           |
|                |                                                                        |                                                                                                                                                                                                                            | - 0x02: SoftAP                                                                                                                                                                                                                                        |
...
+-----------------+----------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 0x7 (b'000111)  | Set the authentication mode for SoftAP mode.       |                                                                                                                                                                                                                                                                                        | data\[0\]：                                                                                                                                                                                                                                                                         |
|                 |                                                    |                                                                                                                                                                                                                                                                                        |                                                                                                                                                                                                                                                                                     |
|                 |                                                    |                                                                                                                                                                                                                                                                                        | - 0x00: OPEN                                                                                                                                                                                                                                                                        |
|                 |                                                    |                                                                                                                                                                                                                                                                                        | - 0x01: WEP                                                                                                                                                                                                                                                                         |
|                 |                                                    |                                                                                                                                                                                                                                                                                        | - 0x02: WPA_PSK                                                                                                                                                                                                                                                                     |
...
+-----------------+----------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 0x15 (b'010101) | Set the Wi-Fi connection end reason.               |                                                                                                                                                                                                                                                                                        | data\[0\] represents the Wi-Fi connection end reason, whose type shall be same with struct [wifi_err_reason_t]{.title-ref}.                                                                                                                                                         |
+-----------------+----------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 0x16 (b'010110) | Set the RSSI at Wi-Fi connection end.              |                                                                                                                                                                                                                                                                                        | data\[0\] represents the RSSI at Wi-Fi connection end. If there is no meaningful RSSI in the connection end, this value shall be the meaningless one, which is [-128]{.title-ref}.                                                                                                  |
+-----------------+----------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
