---
original_file_path: migration-guides/release-6.x/6.0/bluetooth-classic.rst
---
...
>
> - `/bt/host/bluedroid/api/include/api/esp_bt_device.h`{.interpreted-text role="component_file"}
>
...
>
> - `/bt/host/bluedroid/api/include/api/esp_spp_api.h`{.interpreted-text role="component_file"}
>
...
>
> - `/bt/host/bluedroid/api/include/api/esp_hf_ag_api.h`{.interpreted-text role="component_file"}
>
...
>
> > - `/bt/host/bluedroid/api/include/api/esp_gap_bt_api.h`{.interpreted-text role="component_file"}
> >
...
>
> - `/bt/host/bluedroid/api/include/api/esp_sdp_api.h`{.interpreted-text role="component_file"}
>
...
>
> - `/bt/host/bluedroid/api/include/api/esp_a2dp_api.h`{.interpreted-text role="component_file"}
>
