---
original_file_path: api-guides/jtag-debugging/debugging-examples.rst
---
...
This section describes debugging with GDB from `jtag-debugging-examples-eclipse`{.interpreted-text role="ref"} as well as from `jtag-debugging-examples-command-line`{.interpreted-text role="ref"}.

## Eclipse {#jtag-debugging-examples-eclipse}

Verify if your target is ready and loaded with `get-started/blink`{.interpreted-text role="example"} example. Configure and start debugger following steps in section `jtag-debugging-using-debugger-eclipse`{.interpreted-text role="ref"}. Pick up where target was left by debugger, i.e., having the application halted at breakpoint established at `app_main()`.

<figure class="align-center">
<img src="../../../_static/debug-perspective.jpg" alt="Debug Perspective in Eclipse" />
<figcaption aria-hidden="true">Debug Perspective in Eclipse</figcaption>
</figure>

### Examples in This Section

1.  `jtag-debugging-examples-eclipse-01`{.interpreted-text role="ref"}
2.  `jtag-debugging-examples-eclipse-02`{.interpreted-text role="ref"}
3.  `jtag-debugging-examples-eclipse-03`{.interpreted-text role="ref"}
4.  `jtag-debugging-examples-eclipse-04`{.interpreted-text role="ref"}
5.  `jtag-debugging-examples-eclipse-05`{.interpreted-text role="ref"}
6.  `jtag-debugging-examples-eclipse-06`{.interpreted-text role="ref"}
7.  `jtag-debugging-examples-eclipse-07`{.interpreted-text role="ref"}

### Navigating Through the Code, Call Stack and Threads {#jtag-debugging-examples-eclipse-01}
...
<figure class="align-center">
<img src="../../../_static/debugging-target-halted.jpg" alt="Target halted during debugging" />
<figcaption aria-hidden="true">Target halted during debugging</figcaption>
</figure>
...
<figure class="align-center">
<img src="../../../_static/debugging-navigate-through-the-stack.jpg" alt="Navigate through the call stack" />
<figcaption aria-hidden="true">Navigate through the call stack</figcaption>
</figure>
...
### Setting and Clearing Breakpoints {#jtag-debugging-examples-eclipse-02}
...
<figure class="align-center">
<img src="../../../_static/debugging-setting-breakpoint.jpg" alt="Setting a breakpoint" />
<figcaption aria-hidden="true">Setting a breakpoint</figcaption>
</figure>

Information how many breakpoints are set and where is shown in window \"Breakpoints\" on top right. Click \"Show Breakpoints Supported by Selected Target\" to refresh this list. Besides the two just set breakpoints the list may contain temporary breakpoint at function `app_main()` established at debugger start. As maximum two breakpoints are allowed (see `jtag-debugging-tip-breakpoints`{.interpreted-text role="ref"}), you need to delete it, or debugging will fail.

<figure class="align-center">
<img src="../../../_static/debugging-three-breakpoints-set.jpg" alt="Three breakpoints are set / maximum two are allowed" />
<figcaption aria-hidden="true">Three breakpoints are set / maximum two are allowed</figcaption>
</figure>
...
Read more about breakpoints under `jtag-debugging-tip-breakpoints`{.interpreted-text role="ref"} and `jtag-debugging-tip-where-breakpoints`{.interpreted-text role="ref"}

### Halting the Target Manually {#jtag-debugging-examples-eclipse-03}
...
<figure class="align-center">
<img src="../../../_static/debugging-target-halted-manually.jpg" alt="Target halted manually" />
<figcaption aria-hidden="true">Target halted manually</figcaption>
</figure>
...
### Stepping Through the Code {#jtag-debugging-examples-eclipse-04}
...
<figure class="align-center">
<img src="../../../_static/debugging-step-over.jpg" alt="Stepping through the code with &quot;Step Over (F6)&quot;" />
<figcaption aria-hidden="true">Stepping through the code with "Step Over (F6)"</figcaption>
</figure>

If you press \"Step Into (F5)\" instead, then debugger will step inside subroutine calls.

<figure class="align-center">
<img src="../../../_static/debugging-step-into.jpg" alt="Stepping through the code with &quot;Step Into (F5)&quot;" />
<figcaption aria-hidden="true">Stepping through the code with "Step Into (F5)"</figcaption>
</figure>

In this particular case debugger stepped inside `gpio_set_level(BLINK_GPIO, 0)` and effectively moved to `gpio.c` driver code.

See `jtag-debugging-tip-why-next-works-as-step`{.interpreted-text role="ref"} for potential limitation of using `next` command.

### Checking and Setting Memory {#jtag-debugging-examples-eclipse-05}
...
For more information, see *{IDF_TARGET_NAME} Technical Reference Manual* \> *IO MUX and GPIO Matrix (GPIO, IO_MUX)* \[[PDF]({IDF_TARGET_TRM_EN_URL}#iomuxgpio)\].
...
<figure class="align-center">
<img src="../../../_static/debugging-memory-location-on.jpg" alt="Observing memory location 0x3FF44004 changing one bit to ON&quot;" />
...
<figure class="align-center">
<img src="../../../_static/debugging-memory-location-off.jpg" alt="Observing memory location 0x3FF44004 changing one bit to ON&quot;" />
...
### Watching and Setting Program Variables {#jtag-debugging-examples-eclipse-06}
...
<figure class="align-center">
<img src="../../../_static/debugging-watch-variable.jpg" alt="Watching program variable &quot;i&quot;" />
<figcaption aria-hidden="true">Watching program variable "i"</figcaption>
</figure>
...
### Setting Conditional Breakpoints {#jtag-debugging-examples-eclipse-07}
...
<figure class="align-center">
<img src="../../../_static/debugging-setting-conditional-breakpoint.jpg" alt="Setting a conditional breakpoint" />
<figcaption aria-hidden="true">Setting a conditional breakpoint</figcaption>
</figure>
...
## Command Line {#jtag-debugging-examples-command-line}

Verify if your target is ready and loaded with `get-started/blink`{.interpreted-text role="example"} example. Configure and start debugger following steps in section `jtag-debugging-using-debugger-command-line`{.interpreted-text role="ref"}. Pick up where target was left by debugger, i.e. having the application halted at breakpoint established at `app_main()`:
...
1.  `jtag-debugging-examples-command-line-01`{.interpreted-text role="ref"}
2.  `jtag-debugging-examples-command-line-02`{.interpreted-text role="ref"}
3.  `jtag-debugging-examples-command-line-03`{.interpreted-text role="ref"}
4.  `jtag-debugging-examples-command-line-04`{.interpreted-text role="ref"}
5.  `jtag-debugging-examples-command-line-05`{.interpreted-text role="ref"}
6.  `jtag-debugging-examples-command-line-06`{.interpreted-text role="ref"}
7.  `jtag-debugging-examples-command-line-07`{.interpreted-text role="ref"}
8.  `jtag-debugging-examples-command-line-08`{.interpreted-text role="ref"}

### Navigating Through the Code, Call Stack and Threads {#jtag-debugging-examples-command-line-01}
...
### Setting and Clearing Breakpoints {#jtag-debugging-examples-command-line-02}
...
### Halting and Resuming the Application {#jtag-debugging-examples-command-line-03}
...
### Stepping Through the Code {#jtag-debugging-examples-command-line-04}
...
### Checking and Setting Memory {#jtag-debugging-examples-command-line-05}
...
### Watching and Setting Program Variables {#jtag-debugging-examples-command-line-06}
...
You may have up to two watchpoints, see `jtag-debugging-tip-breakpoints`{.interpreted-text role="ref"}.

### Setting Conditional Breakpoints {#jtag-debugging-examples-command-line-07}
...
### Debugging FreeRTOS Objects {#jtag-debugging-examples-command-line-08}
...
The freertos-gdb Python module is included as a Python package requirement by ESP-IDF, thus should be automatically installed (see `get-started-set-up-tools`{.interpreted-text role="ref"} for more details).
