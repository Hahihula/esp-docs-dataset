---
original_file_path: api-reference/system/ulp_instruction_set.rst
---
...
## Note About Addressing {#ulp-fsm-addressing}
...
Note that the offset specified in bytes is converted to a 32-bit word offset before execution. See the section `ulp-fsm-addressing`{.interpreted-text role="ref"} for more details.
::::
