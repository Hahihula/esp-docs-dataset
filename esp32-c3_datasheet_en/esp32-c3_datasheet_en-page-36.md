...
ESP32-C3 has 22 or 16 GPIO pins which can be assigned various functions by configuring corresponding registers. Besides digital signals, some GPIOs can also be used for analog functions, such as ADC.
...
Espressif Systems  
Page number: **36**  
Document version: ESP32-C3 Series Datasheet v2.2  
