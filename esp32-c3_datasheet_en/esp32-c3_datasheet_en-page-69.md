...
| v1.0 and higher | Official release — major changes will be communicated via Product Change Notifications (PCN). | Not Recommended for New Design (NRND)¹ | This datasheet is publicly released for products in mass production. Specifications are finalized, and this datasheet title page only when all the product variants covered by this datasheet have reached end of life. |
| Any version | — | End Of Life (EOL)² | This datasheet is updated less frequently for products not recommended for new designs. |
