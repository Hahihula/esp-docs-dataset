...
- **Subtitle:** operation when the CPU is in Light-sleep mode
...
- **Reference:** For details, see [ESP32-C5 Technical Reference Manual](#) > Chapter LED PWM Controller.
...
**Title: 5.2.1.8 Pulse Count Controller**

**Subtitle:** Pulse Count Controller
...
**Reference:** For details, see [ESP32-C5 Technical Reference Manual](#) > Chapter Pulse Count Controller.
...
**Title: 5.2.1.9 Motor Control PWM**
