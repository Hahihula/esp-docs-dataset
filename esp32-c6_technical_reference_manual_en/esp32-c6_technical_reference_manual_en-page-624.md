...
ASSIST_DEBUG_CORE_O_SP_SPILL_MIN_ENA Configures whether to monitor SP exceeding the lower bound address of SP monitored region.
- O: Not Monitor
- 1: Monitor
(R/W)

ASSIST_DEBUG_CORE_O_SP_SPILL_MAX_ENA Configures whether to monitor SP exceeding the upper bound address of SP monitored region.
- O: Not Monitor
- 1: Monitor
(R/W)
```