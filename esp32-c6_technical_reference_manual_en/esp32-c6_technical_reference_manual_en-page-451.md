...
```markdown
Register 12.14. PMU_HP_MODEM_HP_SYS_CNTL_REG (0x0044)
...
Configures whether to hold LP GPIO's configuration in HP_MODEM state.
O: Do not hold
1: Hold
(R/W)

PMU_HP_MODEM_HP_PAD_HOLD_ALL
Configures whether to hold GPIO's configuration in HP_MODEM state.
O: Do not hold
1: Hold
(R/W)
...
Configures whether to stall HP CPU in HP_MODEM state.
O: Do not stall
1: Stall
(R/W)
```