...
The timer groups on ESP32-C6 support the Event Task Matrix (ETM) function, which allows timer groups’ ETM tasks to be triggered by any peripherals’ ETM events, or timer groups’ ETM events to trigger any peripherals’ ETM tasks. This section introduces the ETM tasks and events related to timer groups. For more information, please refer to Chapter 11 Event Task Matrix (SOC_ETM).
