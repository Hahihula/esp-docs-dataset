...
The message and its padding must be parsed into N 512-bit blocks, M⁽¹⁾, M⁽²⁾, ..., M⁽ᴺ⁾. Since the 512 bits of the input block may be expressed as sixteen 32-bit words, the first 32 bits of message block i are denoted M₀⁽ⁱ⁾, the next 32 bits are M₁⁽ⁱ⁾, and so on up to M₁₅⁽ⁱ⁾.
