...
```markdown
Register 29.25. I2C_COMDO_REG (0x0058)
...
ack_check_en, ack_exp and ack are used to control the ACK bit. See I2C cmd structure 29.4-2 for more information.
(R/W)
...
Register 29.26. I2C_COMD1_REG (0x005C)
