...
| Hold time (repeated) START condition. After this period, the first clock pulse is generated | tHD:STA   | 4.0                     –       | –                   –         | µs   |
...
| Data hold time: for CBUS compatible masters (see NOTE, Section 10.1.3)     | tHD:DAT   | 5.0<br>0(2)             –<br>–                       | –                   0.9(3)<br>(ns)(4) | µs   |
| for I²C-bus devices                                                      |          |                         |                     |      |
