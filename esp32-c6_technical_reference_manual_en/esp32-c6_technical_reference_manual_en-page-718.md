...
*   BlockA: the block whose key purpose is EFUSE_KEY_PURPOSE_XTS_AES_128_KEY (please refer to Table 6.3-2 Secure Key Purpose Values). If BlockA exists, a 256-bit KeyA is stored in it.
...
*   Base address: the base_addr of the target memory space. It is a 24-bit physical address, with a range of 0x0000_0000 ~ 0x00FF_FFFF. It should be aligned to size, i.e., base_addr % size == 0.
