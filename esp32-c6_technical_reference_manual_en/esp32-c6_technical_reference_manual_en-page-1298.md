...
```markdown
Register 36.73. MCPWM_EVT_EN_REG (0x0120)

Continued from the previous page...

MCPWM_EVT_TZO_CBC_EN Configures whether or not to enable cycle by cycle trip0 event generation.
O: Disable
1: Enable
(R/W)
...
MCPWM_EVT_TZO_OST_EN Configures whether or not to enable one shot trip0 event generation.
O: Disable
1: Enable
(R/W)
...
MCPWM_EVT_CAPO_EN Configures whether or not to enable capture0 event generation.
O: Disable
1: Enable
(R/W)
