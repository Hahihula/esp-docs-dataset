...
```markdown
Register 27.55. LP_UART_IDLE_CONF_SYNC_REG (0x0048)

| Bit | Description                                                                 |
|-----|-----------------------------------------------------------------------------|
| 31  | (reserved)                                                                  |
| 20  | LP_UART_TX_IDLE_NUM                                                         |
| 19  | LP_UART_RX_IDLE_THRHD                                                      |
| 10  | 0x100                                                                       |
| 9   | 0x100                                                                       |
| 8-0 | Reset                                                                       |
...
Register 27.56. LP_UART_DELAY_CONF_SYNC_REG (0x004C)
...
LP_UART_DLO_EN Configures whether or not to add a turnaround delay of 1 bit before the start bit.
0: Not add
1: Add
(R/W)
