...
Upon overflow of the 64b timer counter, the `MTOF/UOTOF` bit in `MTIMECTL/UTIMECTL` gets set. It can be cleared after appropriate handling of the overflow situation.
