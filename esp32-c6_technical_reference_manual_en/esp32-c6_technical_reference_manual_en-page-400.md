...
An ETM channel can be set up to choose which event to receive by configuring the SOC_ETM_CHn_EVT_ID field. Table 11.3-1 shows the configuration values of SOC_ETM_CHn_EVT_ID and their corresponding events.
