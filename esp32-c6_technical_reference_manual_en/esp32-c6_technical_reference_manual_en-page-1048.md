...
```markdown
Register 32.9. USB_SERIAL_JTAG_GET_LINE_CODE_W1_REG (0x005C)
...
| 15-8      | USB_SERIAL_JTAG_GET_BCHAR_FORMAT          | Configures the value of bCharFormat set by software, which is requested by GET_LINE_CODING command. (R/W) |

Register 32.10. USB_SERIAL_JTAG_CONFIG_UPDATE_REG (0x0060)
