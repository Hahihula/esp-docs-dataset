...
EFUSE_JTAG_SEL_ENABLE Represents whether the selection of a JTAG signal source through the strapping value of GPIO15 is enabled when both EFUSE_DIS_PAD_JTAG and EFUSE_DIS_USB_JTAG are configured to O.
1: Enabled
O: Disabled
(RO)
