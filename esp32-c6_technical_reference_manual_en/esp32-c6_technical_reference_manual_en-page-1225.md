...
|                                                                                              |                                                   | all the timers stop counting and the PWM signals output by all PWM operators remain unchanged |
| MCPWM_TASK_GEN_STOP_EN            | MCPWM_TASK_GEN_STOP                                 | timer stamp B of the PWM operator x is updated to the value of the shadow register |
|                                                                                              |                                                   | MCPWM_GENx_B                                                                      |
```