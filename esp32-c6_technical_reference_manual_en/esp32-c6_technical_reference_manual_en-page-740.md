...
```markdown
Figure 27.4-4 is the structure of a special character AT_CMD. If the receiver constantly receives AT_CMD_CHAR and the following conditions are met, a UART_AT_CMD_CHAR_DET_INT interrupt is generated.
...
DE can be controlled by either software or hardware. To reduce the cost of software, in our design DE is controlled by hardware. As shown in Figure 27.4-5, DE is connected to dtrn_out of UART (please refer to Section 27.4.9.1 for more details).

![Figure 27.4-5. Driver Control Diagram in RS485 Mode](image-placeholder)

**Figure 27.4-5. Driver Control Diagram in RS485 Mode**

```
UART
TXD ──┬──[RS485 transceiver] D+
     │   DE
     │   RE
RXD ──┴──[RS485 transceiver] D-
```