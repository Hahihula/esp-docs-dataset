...
MCPWM_EVT_FO_EN        Configures whether or not to enable FAULT0 event generation.
    0: Disable
    1: Enable
    (R/W)
...
MCPWM_EVT_FO_CLR_EN    Configures whether or not to enable FAULT0 clear event generation.
    0: Disable
    1: Enable
    (R/W)
