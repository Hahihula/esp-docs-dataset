...
- SCL clock controller (SCL_FSM): generate the timing sequence conforming to the I2C protocol. Figure 29.3-3 and Figure 29.3-4 are the timing diagram and corresponding parameters of the I2C protocol.
