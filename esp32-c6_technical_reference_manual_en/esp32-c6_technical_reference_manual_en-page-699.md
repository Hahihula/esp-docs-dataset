...
*   To enable this function: write 1 to register `SHA_IRQ_ENA_REG`.
*   Note that the interrupt should be cleared by software after use via setting the `SHA_CLEAR_IRQ_REG` register to 1.
