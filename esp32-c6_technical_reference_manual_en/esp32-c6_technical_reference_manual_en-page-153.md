...
```markdown
Register 4.11. GDMA_IN_CONFO_CHn_REG (n: 0-2) (0x0070+0xC0*n)
...
GDMA_INDSCR_BURST_EN_CHn Configures whether or not to enable INCR burst transfer for RX channel n to read descriptors.
O: Disable
1: Enable
(R/W)
...
GDMA_MEM_TRANS_EN_CHn Configures whether or not to enable memory-to-memory data transfer.
O: Disable
1: Enable
(R/W)
