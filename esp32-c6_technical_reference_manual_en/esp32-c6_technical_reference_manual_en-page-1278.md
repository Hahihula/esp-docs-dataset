...
Register 36.57. MCPWM_FH2_STATUS_REG (0x00E0)

| Bit | Field Name                  | Description                                                                 |
|-----|-----------------------------|-----------------------------------------------------------------------------|
| 31  |                             |                                                                             |
|     |                             | (reserved)                                                                  |
| 2   | MCPWM_FH2_CBC_ON            | Represents set and reset by hardware. If set, a cycle-by-cycle mode action is ongoing. (RO) |
| 1   | MCPWM_FH2_OST_ON            | Represents set and reset by hardware. If set, a one-shot mode action is ongoing. (RO) |
```