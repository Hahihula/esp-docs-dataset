...
| 26  | LEDC_PARA_UP_CHn Configures whether or not to update LEDC_HPOINT_CHn, LEDC_DUTY_START_CHn, LEDC_SIG_OUT_EN_CHn, LEDC_TIMER_SEL_CHn, and LEDC_OVF_CNT_EN_CHn fields for channel n. <br> O: Invalid. No effect <br> 1: Update (WT) |
...
| 24  | LEDC_OVF_CNT_EN_CHn Configures whether or not to enable the overflow counter of channel n. <br> O: Disable <br> 1: Enable (R/W) |
