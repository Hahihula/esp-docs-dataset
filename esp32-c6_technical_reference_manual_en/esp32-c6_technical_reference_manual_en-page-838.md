...
The registers, related to GP-SPI2 state control, are listed in Table 28.5-7. Users can enable QPI mode for GP-SPI2 by setting the bit SPI_QPI_MODE in register SPI_USER_REG.
