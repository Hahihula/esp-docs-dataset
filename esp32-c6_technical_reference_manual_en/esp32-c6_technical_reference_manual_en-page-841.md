...
|--------------|-------------|------------|------------------------------------|
| 0 - 7        | [31:24]     | 1          | ADDR_VALUE[ADDR_BITLEN + 24:24] is sent first.<br>0           | ADDR_VALUE[31:31 - ADDR_BITLEN] is sent first. |
|              |             |            |                                    |
| 8 - 15       | [31:16]     | 1          | ADDR_VALUE[31:24] is sent first, and then<br>0           | ADDR_VALUE[31:24] is sent first, and then<br>ADDR_VALUE[23:31 - ADDR_BITLEN] is sent. |
|              |             |            |                                    |
| 16 - 23      | [31:8]      | 1          | ADDR_VALUE[31:16] is sent first, and then<br>0           | ADDR_VALUE[ADDR_BITLEN - 8:8] is sent.<br>ADDR_VALUE[31:16] is sent first, and then<br>ADDR_VALUE[15:31 - ADDR_BITLEN] is sent. |
|              |             |            |                                    |
| 24 - 31      | [31:0]      | 1          | ADDR_VALUE[31:8] is sent first, and then<br>0           | ADDR_VALUE[ADDR_BITLEN - 24:0] is sent.<br>ADDR_VALUE[31:8] is sent first, and then<br>ADDR_VALUE[7:31 - ADDR_BITLEN] is sent. |
```
