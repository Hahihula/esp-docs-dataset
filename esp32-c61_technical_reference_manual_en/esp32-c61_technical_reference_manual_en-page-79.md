...
CLIC stands for core-local interrupt controller, which provides low-latency, vectored, pre-emptive interrupts for HP core. The HP core CLIC unit supports 32 external interrupts and 2 CLINT interrupts.
...
Each interrupt can be either vectored or non-vectored depending on the clicintrattr[i].SHV bit.
