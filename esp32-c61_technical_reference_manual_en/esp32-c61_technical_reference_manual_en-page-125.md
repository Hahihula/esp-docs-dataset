...
Figure 2.2-1 shows the instruction delta trace flow.

* The HP CPU core provides an instruction trace interface that outputs the instruction information executed by the HP CPU. Such information includes instruction address, instruction type, etc. For more details about ESP32-C61 HP CPU's instruction trace interface, please refer to Chapter 1 ESP-RISC-V CPU.
...
Figure 2.2-1. Trace Flow Overview

Espressif Systems
125 ESP32-C61 TRM (Pre-release v0.5)
