...
Figure 30.3-1 shows the functional block diagram of the SDIO slave module.

![Figure 30.3-1. SDIO Slave Block Diagram](image_path)

In this figure, the Host represents any device compatible with SDIO Specification V2.00. It communicates with the ESP32-C61 (configured as the SDIO slave) via the standard SDIO bus.
...
## 30.4 Standards Compliance

The ESP32-C61 SDIO Slave Controller conforms to the following standards:
