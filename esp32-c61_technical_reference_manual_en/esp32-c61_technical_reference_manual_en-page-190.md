...
```markdown
## Register 3.32. AHB_DMA_IN_STATE_CHn_REG (n: 0-1) (0x0084+0xC0*n)
...
| 20..19    |                                |
| 18..17    |                                |
| 16..0     | AHB_DMA_IN_STATE_CHn           |
|           | (reserved)                     |
|           | AHB_DMA_IN_DSCR_STATE_CHn      |
|           | AHB_DMA_INLINK_DSCR_ADDR_CHn   |
|           | Reset                           |
...
## Register 3.33. AHB_DMA_IN_SUC_EOF_DES_ADDR_CHn_REG (n: 0-1) (0x0088+0xC0*n)
...
|           |                                |
|           |                                |
|           | AHB_DMA_IN_SUC_EOF_DES_ADDR_CHn|
|           | Reset                           |
