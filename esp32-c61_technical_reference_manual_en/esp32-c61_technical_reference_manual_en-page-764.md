...
```markdown
Register 19.4. LP_ANA_FIB_ENABLE_REG (0x000C)
...
O: Controlled by LP_ANA_PWR_GLITCH_RESET_ENA
1: Forcibly enabled by hardware (R/W)

Register 19.5. LP_ANA_INT_RAW_REG (0x0010)

LP_ANA_BOD_MODEO_INT_RAW The raw interrupt status of LP_ANA_BOD_MODEO_INT. (R/WTC/SS)

Register 19.6. LP_ANA_INT_ST_REG (0x0014)
