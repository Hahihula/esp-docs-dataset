...
| aaa........aaaaaa01   | aaa........aaaaaaa00 | 4            |
| aaa........aaaaaa011  | aaa........aaaaaaa000 | 8            |
| aaa........aaaaaa0111 | aaa........aaaaaaa0000 | 16           |
| ...             | ...                 |              |
| aaaa...01111111       | aaa...aaa0000000    | 2^8          |

### 1.10.2.4 Trigger Execution Flow
...
*   `mpnte` is set to the value in `mte` right before trap
*   `mte` is set to 0
*   `hit` bit is set to 1, corresponding to the trigger(s) which fired
