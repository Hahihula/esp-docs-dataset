...
|-----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|
|     | RTC_WDT_EN | RTC_WDT_STGO | RTC_WDT_STG1 | RTC_WDT_STG2 | RTC_WDT_STG3 | RTC_WDT_CPU_RESET_LENGTH | RTC_WDT_SYS_RESET_LENGTH | RTC_WDT_FLASHBOOT_MOD_EN | RTC_WDT_PROCPU_RESET_EN | (reserved) |
