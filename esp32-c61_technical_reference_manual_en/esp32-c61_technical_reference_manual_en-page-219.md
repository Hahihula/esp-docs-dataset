...
|-------|---------------------------------------------------------------------------------|------------------------------------------------------------|
| 0     | EFUSE_RD_WR_DISO_REG                                                            | EFUSE_PGM_DATAO_REG                                        |
| 0     | EFUSE_RD_REPEAT_DATAO ~ 4_REG                                                   | EFUSE_PGM_DATA1 ~ 5_REG                                    |
| 1     | EFUSE_RD_MAC_SYS_0 ~ 5_REG                                                       | EFUSE_PGM_DATAO ~ 5_REG                                    |
| 2     | EFUSE_RD_SYS_PART1_0 ~ 7_REG                                                    | EFUSE_PGM_DATAO ~ 7_REG                                    |
| 3     | EFUSE_RD_USR_DATAO ~ 7_REG                                                      | EFUSE_PGM_DATAO ~ 7_REG                                    |
| 4-9   | EFUSE_RD_KEYn_DATAO ~ 7_REG (n: 0 ~ 5)                                          | EFUSE_PGM_DATAO ~ 7_REG                                    |
| 10    | EFUSE_RD_SYS_PART2_0 ~ 7_REG                                                    | EFUSE_PGM_DATAO ~ 7_REG                                    |
