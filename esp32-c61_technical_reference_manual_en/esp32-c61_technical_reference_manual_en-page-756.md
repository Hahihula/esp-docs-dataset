...
```markdown
Figure 19.3-1. Architecture of Power Supply Detector


### 19.3.2 Brown-out Detector
...
LP_ANA_BOD_MODEO_INTR_RAW indicates the detection result from the brown-out detector. By default, this register reads a value of 0. It changes to 1 when the voltage on the monitored pin falls below a predefined threshold.
