...
```markdown
Register 27.25. I2C_COMDO_REG (0x0058)
...
ack_check_en, ack_exp, and ack are used to control the ACK bit. See I2C cmd structure 27.4-2 for more information.
(R/W)
...
I2C_COMMAND1 Configures command 1. See details in I2C_COMMANDO. (R/W)
