...
- `1`: Action for this trigger will be taken after the instruction that triggered it is executed. It should be taken before the next instruction is executed. (R/W)
...
- `0x3`: The trigger will attempt to match against 32-bit memory accesses (R/W)
...
Note: Writing an invalid value will set this to the default value `0x0`. (R/W)
