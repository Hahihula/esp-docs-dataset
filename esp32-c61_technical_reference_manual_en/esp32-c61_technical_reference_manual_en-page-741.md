...
```markdown
Register 18.16. BUS_MONITOR_CORE_O_MONTR_ENA_REG (0x0000)
```

Continued from the previous page...

```markdown
BUS_MONITOR_CORE_O_AREA_PIF_O_WR_ENA Configures whether to monitor write operations in region 0 by the Peripheral bus.
O: Not Monitor
1: Monitor
(R/W)
