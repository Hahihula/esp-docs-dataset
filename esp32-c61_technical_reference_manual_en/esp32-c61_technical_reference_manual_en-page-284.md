...
```markdown
Register 6.9. GPIO_STATUS_REG (0x0074)
...
GPIO_STATUS_INTERRUPT The interrupt status of GPIO0~GPIO13 and GPIO22~GPIO29, can be configured by the software.
Bit[0]~bit[13] and bit[22]~bit[29] are corresponding to GPIO0~GPIO13 and GPIO22~GPIO29. Each bit represents the status of its corresponding GPIO:
...
Register 6.10. GPIO_STATUS_W1TS_REG (0x0078)
...
GPIO_STATUS_W1TS Configures whether or not to set the interrupt status register GPIO_STATUS_INTERRUPT of GPIO0~GPIO13 and GPIO22~GPIO29.
