...
|-------------------------------|--------------------------------------------------|---------|--------|
| MEM_MONITOR_DATESET_REG       | Version control register                         | 0x03FC  | R/W    |

## 18.6.2 SOther Registers
...
| BUS_MONITOR_CORE_O_AREA_PC_REG            | Represents the PC value when HP CPU region monitor is triggered                                 | 0x0030  | RO     |
| BUS_MONITOR_CORE_O_AREA_SP_REG            | Represents the SP value when HP CPU region monitor is triggered                                 | 0x0034  | RO     |
...
| BUS_MONITOR_CORE_O_SP_PC_REG              | Represents the PC value when HP CPU SP monitor is triggered                                    | 0x0040  | RO     |
