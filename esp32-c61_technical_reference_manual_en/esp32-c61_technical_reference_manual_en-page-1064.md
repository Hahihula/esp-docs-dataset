...
```markdown
Figure 29.2-2. USB Serial/JTAG Block Diagram
...
29.3.1 CDC-ACM USB Interface Functional Description
...
Table 29.3-1. Standard CDC-ACM Control Requests
...
| SET_CONTROL_LINE_STATE   | Set the state of the RTS/DTR lines. See Table 29.3-2                  |
```