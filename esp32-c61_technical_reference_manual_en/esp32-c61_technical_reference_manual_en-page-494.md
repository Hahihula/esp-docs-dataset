...
ESP32-C61 features an advanced low-power management system that can optimize the chip’s power consumption while maintaining its high performance.
...
The following terms related to low-power management are defined in the context of the ESP32-C61 Technical Reference Manual to help readers better understand this document:
...
| PMU states | Refers to four states of the PMU’s state machine. Users can configure the clock gating and power gating of a power domain in each of the four states. |
...
- Supports four configurable PMU states. Software can flexibly configure them according to specific needs.
  - HP_ACTIVE
```