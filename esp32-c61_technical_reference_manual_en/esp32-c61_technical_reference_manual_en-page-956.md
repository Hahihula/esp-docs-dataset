...
SPI_MST_RX_AFIFO_WFULL_ERR_INT_ST   The interrupt status of SPI_MST_RX_AFIFO_WFULL_
ERR_INT.
(RO)

SPI_MST_TX_AFIFO_REMPTY_ERR_INT_ST   The interrupt status of SPI_MST_TX_AFIFO_
REMPTY_ERR_INT.
(RO)
