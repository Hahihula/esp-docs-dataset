...
BUS_MONITOR_CORE_O_SP_SPILL_MIN_INT: Triggered when the HP CPU SP falls below the lower bound of the monitored region.
BUS_MONITOR_CORE_O_SP_SPILL_MAX_INT: Triggered when the HP CPU SP exceeds the upper bound of the monitored region.
...
Each interrupt source can be configured by a common set of registers that are described in Section Interrupt Configuration Registers. The specific registers can be found in Section 18.6 Register Summary.

## 18.5 Programming Procedures

### 18.5.1 Region Monitoring and SP Monitoring Configuration
...
1. Configure the monitored region and SP bounds.
    * Set the HP CPU Data bus region 0 with BUS_MONITOR_CORE_O_AREA_DRAMO_O_MIN_REG and BUS_MONITOR_CORE_O_AREA_DRAMO_O_MAX_REG.
    * Set the HP CPU Data bus region 1 with BUS_MONITOR_CORE_O_AREA_DRAMO_1_MIN_REG and BUS_MONITOR_CORE_O_AREA_DRAMO_1_MAX_REG.
    * Set the HP CPU Peripheral bus region 0 with BUS_MONITOR_CORE_O_AREA_PIF_O_MIN_REG and BUS_MONITOR_CORE_O_AREA_PIF_O_MAX_REG.
    * Set the HP CPU Peripheral bus region 1 with BUS_MONITOR_CORE_O_AREA_PIF_1_MIN_REG and BUS_MONITOR_CORE_O_AREA_PIF_1_MAX_REG.
```