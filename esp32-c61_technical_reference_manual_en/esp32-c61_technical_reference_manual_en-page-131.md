...
| Field   | Bit Width | Description          | Value |
|---------|-----------|----------------------|-------|
| index   | 16        | The index of each packet | O~65536 |
...
Format 3 packets are used for synchronization, and report supporting information. There are 4 subformats defined in the specification. ESP32-C61 only supports 3 of them.
