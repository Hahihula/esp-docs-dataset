...
All the CMD values supported by GP-SPI2 are listed in Table 26.5-13 and Table 26.5-14. Note that the DUMMY state is always in 1-bit mode and lasts for eight SPI_CLK cycles.
```

Table 26.5-13. CMD Values Supported in SPI Mode
