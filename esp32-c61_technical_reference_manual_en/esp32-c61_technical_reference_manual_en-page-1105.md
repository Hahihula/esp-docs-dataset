...
```markdown
Table 30.5-2. SDIO Slave FBR Configuration – cont’d from previous page

| Address | Bit 7           | Bit 6          | Bit 5         | Bit 4 | Bit 3 | Bit 2 | Bit 1     | Bit 0                     |
|---------|-----------------|----------------|---------------|-------|-------|-------|-----------|-----------------------------|
| 0x200   | 0 (Function 2 CSA enable) | 0 (Function 2 supports CSA) |               | O (RFU) |       |       |           | (Function 2 Standard SDIO Function interface code) |
| 0x201   |                 |                |               |         | O     |       |           | (Function 2 Extended standard SDIO Function interface code) |
| 0x202   |                 |                |               | O (RFU) |       |       | R/W (EPS) | O (SPS)                     |
...
30.5.4 I/O Function 1/2 Address Space Map
...
Figure 30.5-4. Function 1/2 Address Space Map

30.5.4.1 Accessing SLC HOST Register Space
