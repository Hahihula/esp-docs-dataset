...
```markdown
Register 3.13. AHB_DMA_IN_LINK_CHn_REG (n: 0-1) (0x0080+0xC0*n)
```

| Bit | Description                                                                 |
|-----|-----------------------------------------------------------------------------|
| 31  | (reserved)                                                                  |
| 5   | AHB_DMA_INLINK_PARK_CHn                                                    |
| 4   | AHB_DMA_INLINK_RESTART_CHn                                                 |
| 3   | AHB_DMA_INLINK_START_CHn                                                   |
| 2   | AHB_DMA_INLINK_STOP_CHn                                                     |
| 1   | AHB_DMA_INLINK_AUTO_RET_CHn                                                |
| 0   | Reset                                                                       |
