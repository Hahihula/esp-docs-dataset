...
2. Configure the alarm following step 2 in Section 13.7.2.
...
* If the next alarm requires a new alarm value and reload value (i.e., different alarm interval per iteration), then TIMG_TOALARML0_REG, TIMG_TOALARMI_REG, TIMG_TO_LOAD_LO, and TIMG_TO_LOAD_HI should be reconfigured as needed. Otherwise, the aforementioned registers should remain unchanged.
...
13.7.4 Timer as Periodic Alarm by ETM
...
5. Configure the time-base counter following step 1 in Section 13.7.1.
6. Configure the alarm following step 2 in Section 13.7.2.
