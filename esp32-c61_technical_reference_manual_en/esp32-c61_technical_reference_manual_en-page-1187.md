...
## 32.4.4 Temperature Measurement Range and Offset

To improve the temperature measurement accuracy, the temperature sensor is designed with five measurement ranges as shown in Table 32.4-1. Each measurement range comes with specific measurement errors. Users do not need to worry about the errors, as they can choose specific offsets to get calibrated data.

Table 32.4-1. Temperature Measurement Range and Offset
...
where offset is the temperature offset shown in Table 32.4-1.

## 32.5 Programming Procedure
