...
1.12.5.2 Functional Description
...
1.12.5.3 Register Summary

The `mestatus.LOCKUP` bit provides lock-up status of individual core.

1.12.5.4 Register Description

Please refer to `mestatus` CSR.
```