...
Figure 31.4-3 illustrates how `Hpointn` and `Lpointn` are used to generate a fixed duty cycle PWM output signal.

![Figure 31.4-3. LED PWM Output Signal Diagram](image)
