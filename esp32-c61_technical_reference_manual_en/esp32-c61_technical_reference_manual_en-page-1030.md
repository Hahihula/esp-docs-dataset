...
The ESP32-C61 I2S module can operate as a master or a slave in half-duplex and full-duplex communications, depending on the configuration of I2S_RX_SLAVE_MOD and I2S_TX_SLAVE_MOD.
* **I2S_TX_SLAVE_MOD**
    - 0: Master TX mode
    - 1: Slave TX mode

Espressif Systems          1030          ESP32-C61 TRM (Pre-release v0.5)
