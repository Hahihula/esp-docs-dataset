...
|----|----|----|----|-----------------|----|-----------------|----|------------------|----|--------------------|-------------------|
|    |    |    |    | UART_WK_MODE_SEL |    | UART_WK_CHAR_MASK |    | UART_WK_CHAR_NUM |    | UART_RX_WAKE_UP_THRD |                   |
| 0x0 | 0x5 |     | 1   |                 | Oxf0 | Reset           |
...
UART_WK_MODE_SEL Configures which wakeup mode to select. See Section 25.4.8 Wakeup for the explanation of each mode.
0: Mode 0
1: Mode 1
2: Mode 2
3: Mode 3
