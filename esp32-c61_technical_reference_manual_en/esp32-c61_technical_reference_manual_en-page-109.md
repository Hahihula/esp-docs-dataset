...
Register 1.101. tdata3 (0x7A3)

mvalue Data used together with mselect. (R/W)
mselect Configures whether the mvalue data is used for matching mcontext value.
O: Ignore mvalue.
