...
Table 7.2-3, Table 7.2-4, Table 7.2-5, and Table 7.2-6 list the derived HP clock sources, HP clocks for each peripheral, derived LP clock sources and LP clocks for each peripheral.
```