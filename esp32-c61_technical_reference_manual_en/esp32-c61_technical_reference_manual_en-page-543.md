...
```markdown
Register 11.31. PMU_HP_SLEEP_HP_SYS_CNTL_REG (0x0078)
...
PMU_HP_SLEEP_LP_PAD_HOLD_ALL  Configures whether to hold LP GPIOs' configuration in HP_SLEEP state.
O: Do not hold
1: Hold
(R/W)

PMU_HP_SLEEP_HP_PAD_HOLD_ALL  Configures whether to hold HP GPIOs' configuration in HP_SLEEP state.
O: Do not hold
1: Hold
(R/W)
...
PMU_HP_SLEEP_DIG_CPU_STALL   Configures whether to stall CPU in HP_SLEEP state.
O: Do not stall
1: Stall
(R/W)
```