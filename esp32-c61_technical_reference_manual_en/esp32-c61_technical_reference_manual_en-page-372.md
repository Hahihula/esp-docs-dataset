...
```markdown
## Register 7.50. PCR_CPU_WAITI_CONF_REG (0x0DEC)
...
PCR_CPU_WAITI_DELAY_NUM Configures the number of delay cycles to turn off the CPU clock after the CPU enters the WFI mode because of WFI

## Register 7.51. PCR_CPU_FREQ_CONF_REG (0x00F0)

PCR_CPU_DIV_NUM Configures the divisor of HP_ROOT_CLK to generate CPU_CLK.
This field should be used together with PCR_AHB_DIV_NUM. (R/W)
```