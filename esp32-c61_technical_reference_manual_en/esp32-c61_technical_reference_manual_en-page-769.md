...
ESP32-C61's ECC accelerator can complete various calculations based on different elliptic curves, thus accelerating the ECC algorithm and ECC-derived algorithms such as ECDSA.

### 20.2 Feature List

ESP32-C61's ECC accelerator has the following features:

*   2 different elliptic curves, namely P-192 and P-256 defined in [FIPS 186-5](#)
*   11 working modes
