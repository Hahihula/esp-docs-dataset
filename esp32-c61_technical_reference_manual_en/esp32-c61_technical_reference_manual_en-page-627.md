...
### 13.7.1 Timer as a Simple Clock
...
### 13.7.2 Timer as One-shot Alarm

1. Configure the time-base counter following step 1 of Section 13.7.1.

2. Configure the alarm.
   - Configure the alarm value by setting `TIMG_TOALARMLO_REG` and `TIMG_TOALARMMHI_REG`.
...
### 13.7.3 Timer as Periodic Alarm by APB

1. Configure the time-base counter following step 1 in Section 13.7.1.
```