...
Note that while this chapter provides the functional descriptions of the watchdog timers, MWDT register descriptions are detailed in Chapter 13 Timer Group (TIMG), and the RWDT and SWD register descriptions are detailed in Section 14.5 Register Summary.
