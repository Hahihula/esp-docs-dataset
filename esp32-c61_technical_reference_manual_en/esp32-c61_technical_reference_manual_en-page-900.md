...
## 26.5.9.4 Half-Duplex Communication (1/2/4-bit Mode)
...
As described in Section 26.5.9.2, the properties of GP-SPI2 states: CMD, ADDR, DUMMY, DOUT and DIN, such as cycle length, value, and parallel bus bit mode, can be set independently. For the register configuration, see Table 26.5-7.
