...
Figure 32.3-1. Temperature Sensor Architecture

As Figure 32.3-1 shows, the temperature sensor module contains the following major blocks:
...
32.4.3 Automatic Temperature Monitoring Modes
