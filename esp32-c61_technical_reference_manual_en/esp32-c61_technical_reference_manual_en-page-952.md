...
SPI_DMA_SEG_TRANS_DONE_INT_CLR Write 1 to clear the SPI_DMA_SEG_TRANS_DONE_INT in-
terrupt.
(WT)
...
SPI_MST_RX_AFIFO_WFULL_ERR_INT_CLR Write          1         to        clear       the
SPI_MST_RX_AFIFO_WFULL_ERR_INT interrupt.
(WT)

SPI_MST_TX_AFIFO_REMPTY_ERR_INT_CLR Write          1         to        clear       the
