...
ESP32-C61 integrates one 12-bit successive approximation ADC (SAR ADC) for measuring analog signals from up to four channels.
...
The following terms related to SAR ADC are defined in the context of the ESP32-C61 Technical Reference Manual to help readers better understand this document:
...
- 12-bit resolution
- Analog inputs sampling from up to four pins
