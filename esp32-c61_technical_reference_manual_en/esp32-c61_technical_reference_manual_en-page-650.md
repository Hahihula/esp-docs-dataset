...
For watchdog timer interrupts, please refer to Section 13.6 Interrupts in Chapter 13 Timer Group (TIMG).

## 14.5 Register Summary

The addresses in this section are relative to RTC_WDT base address provided in Table 4.3-2 in Chapter 4 System and Memory.

The abbreviations given in Column Access are explained in Section Access Types for Registers.

| Name | Description | Address | Access |
|------|-------------|---------|--------|
| configuration register | Configure the RWDT operation | 0x0000 | R/W |
| RTC_WDT_CONFIG0_REG | Configure the RWDT timeout time of stage0 | 0x0004 | R/W |
| RTC_WDT_CONFIG1_REG | Configure the RWDT timeout time of stage1 | 0x0008 | R/W |
| RTC_WDT_CONFIG2_REG | Configure the RWDT timeout time of stage2 | 0x000C | R/W |
| RTC_WDT_CONFIG3_REG | Configure the RWDT timeout time of stage3 | 0x0010 | R/W |
...
MWDT registers are part of the timer submodule and are described in Section 13.8 Register Summary in Chapter 13 Timer Group (TIMG).
