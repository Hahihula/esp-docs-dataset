...
2. Generate a private key:
   ...
   - Once a private key is chosen, it should be burned into the eFuse in ESP32-C61. (Please refer to Chapter 5 eFuse Controller (EFUSE)).
