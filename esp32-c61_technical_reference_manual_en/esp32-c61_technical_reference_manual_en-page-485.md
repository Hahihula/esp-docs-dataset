...
Register 10.24. SOC_ETM_TASK_ST2_CLR_REG (0x01DC)
```
...
SOC_ETM_LEDC_TASK_GAMMA_RESUME_CHO_ST_CLR Configures whether or not to clear LEDC_TASK_GAMMA_RESUME_CHO trigger status.
O: Invalid. No effect
1: Clear
(WT)
