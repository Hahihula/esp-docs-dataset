...
In addition to SPI Boot and Joint Download Boot modes, ESP8685 also supports SPI Download Boot mode.
...
**Table Title: USB Serial/JTAG ROM Message Printing Control**
...
Link Texts/References:
- [ESP32-C3 Technical Reference Manual > Chapter Chip Boot Control](#)

Hyperlinks:
- ESP8685-WROOM-03 Datasheet v1.5 (at the bottom of the page)