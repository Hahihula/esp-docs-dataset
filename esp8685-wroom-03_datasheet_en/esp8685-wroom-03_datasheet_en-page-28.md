...
| | F ≥ FO + 3 MHz(1) | — | — | — | dB |
| | F ≤ FO − 3 MHz | −39 | — | — | dB |
| Image frequency | \( F = F_{\text{image}} \pm 1 \text{ MHz} \) | -29 | — | — | dB |
| Adjacent channel to image frequency | \( F = F_{\text{image}} - 1 \text{ MHz} \) | −34 | — | — | dB |
...
**Footnote:**
1 Refer to the value of Adjacent channel to image frequency when F = \( F_{\text{image}} \) ≈ 1 MHz.

---

### Subtitle: Table 7-13. Bluetooth LE - Receiver Characteristic - 2 Mbps
...
| | F = FO − 2 MHz | −7 | — | — | dB |
| Adjacent channel selectivity C/I | F = FO + 4 MHz(1) | -39 | — | — | dB |
| | F = FO − 4 MHz | –34 | — | — | dB |
| Image frequency | \( F \geq FO + 6 \text{ MHz} \) | — | — | — | dB |
| Adjacent channel to image frequency | \( F = F_{\text{image}} + 2 \text{ MHz} \) | -39 | — | — | dB |
...
Espressif Systems  
Page: 28  
Document Title: ESP8685-WROOM-03 Datasheet v1.5
